...
// Generated for EFR32FG25A021F256IM56.
//
...
pub use acmp_v3 as acmp;
pub use bufc_v3 as bufc;
pub use buram_v0 as buram;
pub use burtc_v1 as burtc;
pub use cmu_v4 as cmu;
pub use dcdc_v4 as dcdc;
pub use devinfo_v18 as devinfo;
pub use dmem_v2_fg25 as dmem;
pub use dpll_v1 as dpll;
pub use emu_v4 as emu;
pub use etampdet_v1 as etampdet;
pub use fsrco_v0 as fsrco;
pub use gpcrc_v0 as gpcrc;
pub use gpio_v4 as gpio;
pub use hfrco_v2 as hfrco;
pub use hfrcoem_v2 as hfrcoem;
pub use hfxo_v4 as hfxo;
pub use hostmailbox_v0 as hostmailbox;
pub use i2c_v0 as i2c;
pub use iadc_v3_fg25 as iadc;
pub use icache_v0 as icache;
pub use ldma_v1 as ldma;
pub use ldmaxbar_v4 as ldmaxbar;
pub use lesense_v1 as lesense;
pub use letimer_v1 as letimer;
pub use lfrco_v0 as lfrco;
pub use lfxo_v1 as lfxo;
pub use mpahbram_v2 as mpahbram;
pub use msc_v4 as msc;
pub use pcnt_v1 as pcnt;
pub use pfmxpprf_v0 as pfmxpprf;
pub use prs_v4 as prs;
pub use radioaes_v1 as radioaes;
pub use rffpll_v1 as rffpll;
pub use scratchpad_v0 as scratchpad;
pub use semailbox_ns_host_v1 as semailbox_ns_host;
pub use smu_v4 as smu;
pub use smu_ns_cfgns_v4 as smu_ns_cfgns;
pub use syscfg_v4 as syscfg;
pub use syscfg_ns_cfgns_v4 as syscfg_ns_cfgns;
pub use sysrtc_v1 as sysrtc;
pub use ulfrco_v1 as ulfrco;
pub use usb_ns_apbs_v1 as usb_ns_apbs;
pub use usbahb_ns_ahbs_v1 as usbahb_ns_ahbs;
pub use usbpll_v1 as usbpll;
pub use vdac_v2_fg25 as vdac;
pub use wdog_v1 as wdog;

/// Memory map (flash/RAM regions, from the CMSIS pdsc).
pub mod memory {
    pub const IROM1_BASE: usize = 0x08000000;
    pub const IROM1_SIZE: usize = 0x00040000;
    pub const IRAM1_BASE: usize = 0x20000000;
    pub const IRAM1_SIZE: usize = 0x00018000;
}
...
pub const ACMP0_S: crate::acmp_v3::Acmp = unsafe { crate::acmp_v3::Acmp::from_ptr(0x49008000 as *mut ()) };
pub const ACMP1: crate::acmp_v3::Acmp = unsafe { crate::acmp_v3::Acmp::from_ptr(0x5900C000 as *mut ()) };
pub const ACMP1_S: crate::acmp_v3::Acmp = unsafe { crate::acmp_v3::Acmp::from_ptr(0x4900C000 as *mut ()) };
pub const BUFC: crate::bufc_v3::Bufc = unsafe { crate::bufc_v3::Bufc::from_ptr(0x52000000 as *mut ()) };
pub const BUFC_S: crate::bufc_v3::Bufc = unsafe { crate::bufc_v3::Bufc::from_ptr(0x42000000 as *mut ()) };
...
pub const BURTC_S: crate::burtc_v1::Burtc = unsafe { crate::burtc_v1::Burtc::from_ptr(0x4006C000 as *mut ()) };
pub const CMU: crate::cmu_v4::Cmu = unsafe { crate::cmu_v4::Cmu::from_ptr(0x50008000 as *mut ()) };
pub const CMU_S: crate::cmu_v4::Cmu = unsafe { crate::cmu_v4::Cmu::from_ptr(0x40008000 as *mut ()) };
pub const DCDC: crate::dcdc_v4::Dcdc = unsafe { crate::dcdc_v4::Dcdc::from_ptr(0x50094000 as *mut ()) };
pub const DCDC_S: crate::dcdc_v4::Dcdc = unsafe { crate::dcdc_v4::Dcdc::from_ptr(0x40094000 as *mut ()) };
...
pub const DMEM_S: crate::dmem_v2_fg25::Dmem = unsafe { crate::dmem_v2_fg25::Dmem::from_ptr(0x400C0000 as *mut ()) };
...
pub const EMU_S: crate::emu_v4::Emu = unsafe { crate::emu_v4::Emu::from_ptr(0x40004000 as *mut ()) };
pub const ETAMPDET: crate::etampdet_v1::Etampdet = unsafe { crate::etampdet_v1::Etampdet::from_ptr(0x500D0000 as *mut ()) };
pub const ETAMPDET_S: crate::etampdet_v1::Etampdet = unsafe { crate::etampdet_v1::Etampdet::from_ptr(0x400D0000 as *mut ()) };
...
pub const EUSART2_S: crate::eusart_v2::Eusart = unsafe { crate::eusart_v2::Eusart::from_ptr(0x400A4000 as *mut ()) };
pub const EUSART3: crate::eusart_v2::Eusart = unsafe { crate::eusart_v2::Eusart::from_ptr(0x500A8000 as *mut ()) };
pub const EUSART3_S: crate::eusart_v2::Eusart = unsafe { crate::eusart_v2::Eusart::from_ptr(0x400A8000 as *mut ()) };
pub const EUSART4: crate::eusart_v2::Eusart = unsafe { crate::eusart_v2::Eusart::from_ptr(0x500AC000 as *mut ()) };
pub const EUSART4_S: crate::eusart_v2::Eusart = unsafe { crate::eusart_v2::Eusart::from_ptr(0x400AC000 as *mut ()) };
...
pub const GPIO_S: crate::gpio_v4::Gpio = unsafe { crate::gpio_v4::Gpio::from_ptr(0x4003C000 as *mut ()) };
...
pub const HFXO0_S: crate::hfxo_v4::Hfxo = unsafe { crate::hfxo_v4::Hfxo::from_ptr(0x4A004000 as *mut ()) };
...
pub const I2C1_S: crate::i2c_v0::I2c = unsafe { crate::i2c_v0::I2c::from_ptr(0x40070000 as *mut ()) };
pub const IADC0: crate::iadc_v3_fg25::Iadc = unsafe { crate::iadc_v3_fg25::Iadc::from_ptr(0x59004000 as *mut ()) };
pub const IADC0_S: crate::iadc_v3_fg25::Iadc = unsafe { crate::iadc_v3_fg25::Iadc::from_ptr(0x49004000 as *mut ()) };
...
pub const LDMA_S: crate::ldma_v1::Ldma = unsafe { crate::ldma_v1::Ldma::from_ptr(0x40040000 as *mut ()) };
pub const LDMAXBAR: crate::ldmaxbar_v4::Ldmaxbar = unsafe { crate::ldmaxbar_v4::Ldmaxbar::from_ptr(0x50044000 as *mut ()) };
pub const LDMAXBAR_S: crate::ldmaxbar_v4::Ldmaxbar = unsafe { crate::ldmaxbar_v4::Ldmaxbar::from_ptr(0x40044000 as *mut ()) };
pub const LESENSE: crate::lesense_v1::Lesense = unsafe { crate::lesense_v1::Lesense::from_ptr(0x59038000 as *mut ()) };
pub const LESENSE_S: crate::lesense_v1::Lesense = unsafe { crate::lesense_v1::Lesense::from_ptr(0x49038000 as *mut ()) };
...
pub const LFRCO_S: crate::lfrco_v0::Lfrco = unsafe { crate::lfrco_v0::Lfrco::from_ptr(0x40024000 as *mut ()) };
...
pub const MPAHBRAM_S: crate::mpahbram_v2::Mpahbram = unsafe { crate::mpahbram_v2::Mpahbram::from_ptr(0xA6020000 as *mut ()) };
pub const MSC: crate::msc_v4::Msc = unsafe { crate::msc_v4::Msc::from_ptr(0x50030000 as *mut ()) };
pub const MSC_S: crate::msc_v4::Msc = unsafe { crate::msc_v4::Msc::from_ptr(0x40030000 as *mut ()) };
...
pub const PFMXPPRF_S: crate::pfmxpprf_v0::Pfmxpprf = unsafe { crate::pfmxpprf_v0::Pfmxpprf::from_ptr(0x400C4000 as *mut ()) };
pub const PRS: crate::prs_v4::Prs = unsafe { crate::prs_v4::Prs::from_ptr(0x50038000 as *mut ()) };
pub const PRS_S: crate::prs_v4::Prs = unsafe { crate::prs_v4::Prs::from_ptr(0x40038000 as *mut ()) };
...
pub const RFFPLL0_S: crate::rffpll_v1::Rffpll = unsafe { crate::rffpll_v1::Rffpll::from_ptr(0x400C8000 as *mut ()) };
...
pub const SMU_S: crate::smu_v4::Smu = unsafe { crate::smu_v4::Smu::from_ptr(0x44008000 as *mut ()) };
...
pub const SMU_S_CFGNS: crate::smu_ns_cfgns_v4::SmuNsCfgns = unsafe { crate::smu_ns_cfgns_v4::SmuNsCfgns::from_ptr(0x4400C000 as *mut ()) };
pub const SYSCFG: crate::syscfg_v4::Syscfg = unsafe { crate::syscfg_v4::Syscfg::from_ptr(0x5007C000 as *mut ()) };
pub const SYSCFG_S: crate::syscfg_v4::Syscfg = unsafe { crate::syscfg_v4::Syscfg::from_ptr(0x4007C000 as *mut ()) };
...
pub const SYSCFG_S_CFGNS: crate::syscfg_ns_cfgns_v4::SyscfgNsCfgns = unsafe { crate::syscfg_ns_cfgns_v4::SyscfgNsCfgns::from_ptr(0x40078000 as *mut ()) };
pub const SYSRTC0: crate::sysrtc_v1::Sysrtc = unsafe { crate::sysrtc_v1::Sysrtc::from_ptr(0x500B0000 as *mut ()) };
pub const SYSRTC0_S: crate::sysrtc_v1::Sysrtc = unsafe { crate::sysrtc_v1::Sysrtc::from_ptr(0x400B0000 as *mut ()) };
...
pub const USBAHB_S_AHBS: crate::usbahb_ns_ahbs_v1::UsbahbNsAhbs = unsafe { crate::usbahb_ns_ahbs_v1::UsbahbNsAhbs::from_ptr(0x46000000 as *mut ()) };
pub const USBPLL0: crate::usbpll_v1::Usbpll = unsafe { crate::usbpll_v1::Usbpll::from_ptr(0x57004000 as *mut ()) };
pub const USBPLL0_S: crate::usbpll_v1::Usbpll = unsafe { crate::usbpll_v1::Usbpll::from_ptr(0x47004000 as *mut ()) };
pub const USB_NS_APBS: crate::usb_ns_apbs_v1::UsbNsApbs = unsafe { crate::usb_ns_apbs_v1::UsbNsApbs::from_ptr(0x57000000 as *mut ()) };
pub const USB_S_APBS: crate::usb_ns_apbs_v1::UsbNsApbs = unsafe { crate::usb_ns_apbs_v1::UsbNsApbs::from_ptr(0x47000000 as *mut ()) };
pub const VDAC0: crate::vdac_v2_fg25::Vdac = unsafe { crate::vdac_v2_fg25::Vdac::from_ptr(0x59024000 as *mut ()) };
pub const VDAC0_S: crate::vdac_v2_fg25::Vdac = unsafe { crate::vdac_v2_fg25::Vdac::from_ptr(0x49024000 as *mut ()) };
