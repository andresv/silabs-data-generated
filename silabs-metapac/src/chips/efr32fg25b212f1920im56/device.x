...
PROVIDE(EUSART3_RX = DefaultHandler);
PROVIDE(EUSART3_TX = DefaultHandler);
PROVIDE(EUSART4_RX = DefaultHandler);
PROVIDE(EUSART4_TX = DefaultHandler);
...
PROVIDE(RFFPLL = DefaultHandler);
PROVIDE(USBPLL0 = DefaultHandler);
PROVIDE(AHB2AHB0 = DefaultHandler);
PROVIDE(AHB2AHB1 = DefaultHandler);
PROVIDE(AHB2AHB2 = DefaultHandler);
PROVIDE(AHB2AHB3 = DefaultHandler);
PROVIDE(RFTIMER = DefaultHandler);
PROVIDE(SOFTM = DefaultHandler);
PROVIDE(RFLDMA = DefaultHandler);
