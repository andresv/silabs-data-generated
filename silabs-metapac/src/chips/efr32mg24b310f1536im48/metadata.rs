...
pub static METADATA: Metadata = Metadata {
    ...
    peripherals: &[
        ...
        Peripheral { name: "MVP", address: 0x5D000000, kind: "mvp", version: "v1", block: "MVP" },
        ...
        Peripheral { name: "SMU", address: 0x54008000, kind: "smu", version: "v3_mvp", block: "SMU" },
        Peripheral { name: "SMU_NS_CFGNS", address: 0x5400C000, kind: "smu_ns_cfgns", version: "v3_mvp", block: "SMU_NS_CFGNS" },
        Peripheral { name: "SMU_S_CFGNS", address: 0x4400C000, kind: "smu_s_cfgns", version: "v3_mvp", block: "SMU_S_CFGNS" },
        Peripheral { name: "SYSCFG", address: 0x5007C000, kind: "syscfg", version: "v3_mvp", block: "SYSCFG" },
