...
// Generated for EFR32MG26B611F2048IM48.
//
...
pub use smu_v7 as smu;
pub use smu_ns_cfgns_v7 as smu_ns_cfgns;
pub use syscfg_v9 as syscfg;
...
pub mod memory {
    ...
    pub const IROM1_SIZE: usize = 0x00200000;
    pub const IRAM1_BASE: usize = 0x20000000;
    pub const IRAM1_SIZE: usize = 0x00060000;
}
...
pub const SMU: crate::smu_v7::Smu = unsafe { crate::smu_v7::Smu::from_ptr(0x54008000 as *mut ()) };
pub const SMU_S: crate::smu_v7::Smu = unsafe { crate::smu_v7::Smu::from_ptr(0x44008000 as *mut ()) };
pub const SMU_NS_CFGNS: crate::smu_ns_cfgns_v7::SmuNsCfgns = unsafe { crate::smu_ns_cfgns_v7::SmuNsCfgns::from_ptr(0x5400C000 as *mut ()) };
pub const SMU_S_CFGNS: crate::smu_ns_cfgns_v7::SmuNsCfgns = unsafe { crate::smu_ns_cfgns_v7::SmuNsCfgns::from_ptr(0x4400C000 as *mut ()) };
pub const SYSCFG: crate::syscfg_v9::Syscfg = unsafe { crate::syscfg_v9::Syscfg::from_ptr(0x50080000 as *mut ()) };
pub const SYSCFG_S: crate::syscfg_v9::Syscfg = unsafe { crate::syscfg_v9::Syscfg::from_ptr(0x40080000 as *mut ()) };
