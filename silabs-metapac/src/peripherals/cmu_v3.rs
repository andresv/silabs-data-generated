...
pub mod regs {
    ...
    impl defmt::Format for Clken1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Clken1 {{ agc: {=bool:?}, modem: {=bool:?}, rfcrc: {=bool:?}, frc: {=bool:?}, protimer: {=bool:?}, rac: {=bool:?}, synth: {=bool:?}, rfscratchpad: {=bool:?}, hostmailbox: {=bool:?}, rfmailbox: {=bool:?}, semailboxhost: {=bool:?}, bufc: {=bool:?}, keyscan: {=bool:?}, smu: {=bool:?}, icache0: {=bool:?}, msc: {=bool:?}, wdog1: {=bool:?}, acmp0: {=bool:?}, acmp1: {=bool:?}, vdac0: {=bool:?}, pcnt0: {=bool:?}, eusart0: {=bool:?}, eusart1: {=bool:?}, rfeca0: {=bool:?}, rfeca1: {=bool:?}, dmem: {=bool:?}, ecaifadc: {=bool:?}, vdac1: {=bool:?}, mvp: {=bool:?} }}",
                self.agc(),
                self.modem(),
                self.rfcrc(),
                self.frc(),
