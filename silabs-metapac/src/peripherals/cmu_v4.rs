...
impl Cmu {
    ...
    #[doc = "No Description."]
    #[inline(always)]
    pub const fn caltop(self) -> crate::common::Reg<regs::Caltop, crate::common::RW> {
    ...
    #[doc = "No Description."]
    #[inline(always)]
    pub const fn dapclkctrl(self) -> crate::common::Reg<regs::Dapclkctrl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0284usize) as _) }
    }
    #[doc = "No Description."]
    #[inline(always)]
    pub const fn lesensehfclkctrl(self) -> crate::common::Reg<regs::Lesensehfclkctrl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0290usize) as _) }
    }
    #[doc = "No Description."]
    #[inline(always)]
    pub const fn usb0clkctrl(self) -> crate::common::Reg<regs::Usb0clkctrl, crate::common::RW> {
    ...
    #[doc = "No Description. (write-1-to-set alias)"]
    #[inline(always)]
    pub const fn caltop_set(self) -> crate::common::Reg<regs::Caltop, crate::common::W> {
    ...
    #[doc = "No Description. (write-1-to-set alias)"]
    #[inline(always)]
    pub const fn dapclkctrl_set(self) -> crate::common::Reg<regs::Dapclkctrl, crate::common::W> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x1284usize) as _) }
    }
    #[doc = "No Description. (write-1-to-set alias)"]
    #[inline(always)]
    pub const fn lesensehfclkctrl_set(self) -> crate::common::Reg<regs::Lesensehfclkctrl, crate::common::W> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x1290usize) as _) }
    }
    #[doc = "No Description. (write-1-to-set alias)"]
    #[inline(always)]
    pub const fn usb0clkctrl_set(self) -> crate::common::Reg<regs::Usb0clkctrl, crate::common::W> {
    ...
    #[doc = "No Description. (write-1-to-clr alias)"]
    #[inline(always)]
    pub const fn caltop_clr(self) -> crate::common::Reg<regs::Caltop, crate::common::W> {
    ...
    #[doc = "No Description. (write-1-to-clr alias)"]
    #[inline(always)]
    pub const fn dapclkctrl_clr(self) -> crate::common::Reg<regs::Dapclkctrl, crate::common::W> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x2284usize) as _) }
    }
    #[doc = "No Description. (write-1-to-clr alias)"]
    #[inline(always)]
    pub const fn lesensehfclkctrl_clr(self) -> crate::common::Reg<regs::Lesensehfclkctrl, crate::common::W> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x2290usize) as _) }
    }
    #[doc = "No Description. (write-1-to-clr alias)"]
    #[inline(always)]
    pub const fn usb0clkctrl_clr(self) -> crate::common::Reg<regs::Usb0clkctrl, crate::common::W> {
    ...
    #[doc = "No Description. (write-1-to-tgl alias)"]
    #[inline(always)]
    pub const fn caltop_tgl(self) -> crate::common::Reg<regs::Caltop, crate::common::W> {
    ...
    #[doc = "No Description. (write-1-to-tgl alias)"]
    #[inline(always)]
    pub const fn dapclkctrl_tgl(self) -> crate::common::Reg<regs::Dapclkctrl, crate::common::W> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x3284usize) as _) }
    }
    #[doc = "No Description. (write-1-to-tgl alias)"]
    #[inline(always)]
    pub const fn lesensehfclkctrl_tgl(self) -> crate::common::Reg<regs::Lesensehfclkctrl, crate::common::W> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x3290usize) as _) }
    }
    #[doc = "No Description. (write-1-to-tgl alias)"]
    #[inline(always)]
    pub const fn usb0clkctrl_tgl(self) -> crate::common::Reg<regs::Usb0clkctrl, crate::common::W> {
...
pub mod regs {
    ...
    impl Calctrl {
        #[doc = "Wrap around Up-counter."]
        #[must_use]
        #[inline(always)]
        pub const fn wrapup(&self) -> bool {
            let val = (self.0 >> 22usize) & 0x01;
            val != 0
        }
        #[doc = "Wrap around Up-counter."]
        #[inline(always)]
        pub const fn set_wrapup(&mut self, val: bool) {
    ...
    impl defmt::Format for Calctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Calctrl {{ wrapup: {=bool:?}, cont: {=bool:?}, upsel: {:?}, downsel: {:?} }}",
                self.wrapup(),
                self.cont(),
                self.upsel(),
                self.downsel()
    ...
    impl Default for Caltop {
        #[inline(always)]
        fn default() -> Caltop {
            Caltop(0)
        }
    }
    impl core::fmt::Debug for Caltop {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Caltop").field("caltop", &self.caltop()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Caltop {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Caltop {{ caltop: {=u32:?} }}", self.caltop())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl defmt::Format for Clken0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Clken0 {{ ldma: {=bool:?}, ldmaxbar: {=bool:?}, radioaes: {=bool:?}, gpcrc: {=bool:?}, timer0: {=bool:?}, timer1: {=bool:?}, timer2: {=bool:?}, timer3: {=bool:?}, timer4: {=bool:?}, timer5: {=bool:?}, iadc0: {=bool:?}, amuxcp0: {=bool:?}, letimer0: {=bool:?}, wdog0: {=bool:?}, i2c0: {=bool:?}, i2c1: {=bool:?}, syscfg: {=bool:?}, dpll0: {=bool:?}, hfrco0: {=bool:?}, hfrcoem23: {=bool:?}, hfxo0: {=bool:?}, fsrco: {=bool:?}, lfrco: {=bool:?}, lfxo: {=bool:?}, ulfrco: {=bool:?}, lesense: {=bool:?}, gpio: {=bool:?}, prs: {=bool:?}, buram: {=bool:?}, burtc: {=bool:?}, sysrtc0: {=bool:?}, dcdc: {=bool:?} }}",
                self.ldma(),
                self.ldmaxbar(),
                self.radioaes(),
                self.gpcrc(),
    ...
    impl defmt::Format for Clken1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Clken1 {{ hostmailbox: {=bool:?}, rffpll0: {=bool:?}, semailboxhost: {=bool:?}, bufc: {=bool:?}, eusart3: {=bool:?}, eusart4: {=bool:?}, smu: {=bool:?}, icache0: {=bool:?}, msc: {=bool:?}, wdog1: {=bool:?}, acmp0: {=bool:?}, acmp1: {=bool:?}, vdac0: {=bool:?}, pcnt0: {=bool:?}, eusart0: {=bool:?}, eusart1: {=bool:?}, eusart2: {=bool:?}, dmem: {=bool:?}, etampdet: {=bool:?}, timer6: {=bool:?}, timer7: {=bool:?}, usb: {=bool:?} }}",
                self.hostmailbox(),
                self.rffpll0(),
                self.semailboxhost(),
                self.bufc(),
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct Dapclkctrl(pub u32);
    impl Dapclkctrl {
        #[doc = "Clock Select."]
        #[must_use]
        #[inline(always)]
        pub const fn clksel(&self) -> super::vals::DapclkctrlClksel {
            let val = (self.0 >> 0usize) & 0x03;
            super::vals::DapclkctrlClksel::from_bits(val as u8)
        }
        #[doc = "Clock Select."]
        #[inline(always)]
        pub const fn set_clksel(&mut self, val: super::vals::DapclkctrlClksel) {
            self.0 = (self.0 & !(0x03 << 0usize)) | (((val.to_bits() as u32) & 0x03) << 0usize);
        }
    }
    impl Default for Dapclkctrl {
        #[inline(always)]
        fn default() -> Dapclkctrl {
            Dapclkctrl(0)
        }
    }
    impl core::fmt::Debug for Dapclkctrl {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Dapclkctrl").field("clksel", &self.clksel()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Dapclkctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Dapclkctrl {{ clksel: {:?} }}", self.clksel())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct Lesensehfclkctrl(pub u32);
    impl Lesensehfclkctrl {
        #[doc = "Clock Select."]
        #[must_use]
        #[inline(always)]
        pub const fn clksel(&self) -> super::vals::LesensehfclkctrlClksel {
            let val = (self.0 >> 0usize) & 0x03;
            super::vals::LesensehfclkctrlClksel::from_bits(val as u8)
        }
        #[doc = "Clock Select."]
        #[inline(always)]
        pub const fn set_clksel(&mut self, val: super::vals::LesensehfclkctrlClksel) {
            self.0 = (self.0 & !(0x03 << 0usize)) | (((val.to_bits() as u32) & 0x03) << 0usize);
        }
    }
    impl Default for Lesensehfclkctrl {
        #[inline(always)]
        fn default() -> Lesensehfclkctrl {
            Lesensehfclkctrl(0)
        }
    }
    impl core::fmt::Debug for Lesensehfclkctrl {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Lesensehfclkctrl")
                .field("clksel", &self.clksel())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Lesensehfclkctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Lesensehfclkctrl {{ clksel: {:?} }}", self.clksel())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl Radioclkctrl {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn clksel(&self) -> super::vals::RadioclkctrlClksel {
            let val = (self.0 >> 8usize) & 0x07;
            super::vals::RadioclkctrlClksel::from_bits(val as u8)
        }
        #[doc = "Clock Select."]
        #[inline(always)]
        pub const fn set_clksel(&mut self, val: super::vals::RadioclkctrlClksel) {
    ...
    impl defmt::Format for Radioclkctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Radioclkctrl {{ en: {=bool:?}, clksel: {:?}, dbgclk: {=bool:?} }}",
                self.en(),
                self.clksel(),
                self.dbgclk()
            )
    ...
    impl defmt::Format for Sysclkctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Sysclkctrl {{ clksel: {:?}, pclkpresc: {:?}, hclkpresc: {:?} }}",
                self.clksel(),
                self.pclkpresc(),
                self.hclkpresc()
            )
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct Usb0clkctrl(pub u32);
    impl Usb0clkctrl {
        #[doc = "Clock Select."]
        #[must_use]
        #[inline(always)]
        pub const fn clksel(&self) -> super::vals::Usb0clkctrlClksel {
            let val = (self.0 >> 0usize) & 0x03;
            super::vals::Usb0clkctrlClksel::from_bits(val as u8)
        }
        #[doc = "Clock Select."]
        #[inline(always)]
        pub const fn set_clksel(&mut self, val: super::vals::Usb0clkctrlClksel) {
            self.0 = (self.0 & !(0x03 << 0usize)) | (((val.to_bits() as u32) & 0x03) << 0usize);
        }
    }
    impl Default for Usb0clkctrl {
        #[inline(always)]
        fn default() -> Usb0clkctrl {
            Usb0clkctrl(0)
        }
    }
    impl core::fmt::Debug for Usb0clkctrl {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Usb0clkctrl").field("clksel", &self.clksel()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Usb0clkctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Usb0clkctrl {{ clksel: {:?} }}", self.clksel())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
...
pub mod vals {
    ...
    impl DapclkctrlClksel {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> DapclkctrlClksel {
    ...
    impl From<u8> for DapclkctrlClksel {
        #[inline(always)]
        fn from(val: u8) -> DapclkctrlClksel {
            DapclkctrlClksel::from_bits(val)
        }
    }
    impl From<DapclkctrlClksel> for u8 {
        #[inline(always)]
        fn from(val: DapclkctrlClksel) -> u8 {
            DapclkctrlClksel::to_bits(val)
        }
    }
    #[repr(u8)]
    #[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
    ...
    #[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
    #[cfg_attr(feature = "defmt", derive(defmt::Format))]
    pub enum LesensehfclkctrlClksel {
        _RESERVED_0 = 0x0,
    ...
    impl LesensehfclkctrlClksel {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> LesensehfclkctrlClksel {
            unsafe { core::mem::transmute(val & 0x03) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for LesensehfclkctrlClksel {
        #[inline(always)]
        fn from(val: u8) -> LesensehfclkctrlClksel {
            LesensehfclkctrlClksel::from_bits(val)
        }
    }
    impl From<LesensehfclkctrlClksel> for u8 {
        #[inline(always)]
        fn from(val: LesensehfclkctrlClksel) -> u8 {
            LesensehfclkctrlClksel::to_bits(val)
        }
    }
    #[repr(transparent)]
    ...
    impl RadioclkctrlClksel {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> RadioclkctrlClksel {
            unsafe { core::mem::transmute(val & 0x07) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for RadioclkctrlClksel {
        #[inline(always)]
        fn from(val: u8) -> RadioclkctrlClksel {
            RadioclkctrlClksel::from_bits(val)
        }
    }
    impl From<RadioclkctrlClksel> for u8 {
        #[inline(always)]
        fn from(val: RadioclkctrlClksel) -> u8 {
            RadioclkctrlClksel::to_bits(val)
        }
    }
    #[repr(u8)]
    #[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
    ...
    pub enum SysclkctrlClksel {
        ...
        Clkin0 = 0x04,
        #[doc = "RFFPLL0SYS is clocking SYSCLK."]
        Rffpll0sys = 0x05,
        _RESERVED_6 = 0x06,
        _RESERVED_7 = 0x07,
    }
    ...
    impl Usb0clkctrlClksel {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Usb0clkctrlClksel {
            unsafe { core::mem::transmute(val & 0x03) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for Usb0clkctrlClksel {
        #[inline(always)]
        fn from(val: u8) -> Usb0clkctrlClksel {
            Usb0clkctrlClksel::from_bits(val)
        }
    }
    impl From<Usb0clkctrlClksel> for u8 {
        #[inline(always)]
        fn from(val: Usb0clkctrlClksel) -> u8 {
            Usb0clkctrlClksel::to_bits(val)
        }
    }
    #[repr(u8)]
    #[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
