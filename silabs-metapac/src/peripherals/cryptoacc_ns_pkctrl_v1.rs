#[doc = "CRYPTOACC_NS_PKCTRL peripheral."]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct CryptoaccNsPkctrl {
    ptr: *mut u8,
}
unsafe impl Send for CryptoaccNsPkctrl {}
unsafe impl Sync for CryptoaccNsPkctrl {}
impl CryptoaccNsPkctrl {
    #[inline(always)]
