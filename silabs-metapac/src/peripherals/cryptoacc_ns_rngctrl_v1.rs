#[doc = "CRYPTOACC_NS_RNGCTRL peripheral."]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct CryptoaccNsRngctrl {
    ptr: *mut u8,
}
unsafe impl Send for CryptoaccNsRngctrl {}
unsafe impl Sync for CryptoaccNsRngctrl {}
impl CryptoaccNsRngctrl {
    #[inline(always)]
