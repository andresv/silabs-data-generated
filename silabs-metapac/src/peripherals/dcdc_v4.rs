...
pub mod regs {
    ...
    impl Em01ctrl0 {
        ...
        #[doc = "EM01 Dec Peak Current Setting."]
        #[must_use]
        #[inline(always)]
        pub const fn ipkdecval(&self) -> u8 {
            let val = (self.0 >> 4usize) & 0x0f;
            val as u8
        }
        #[doc = "EM01 Dec Peak Current Setting."]
        #[inline(always)]
        pub const fn set_ipkdecval(&mut self, val: u8) {
    ...
    impl core::fmt::Debug for Em01ctrl0 {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Em01ctrl0")
                ...
                .field("ipkdecval", &self.ipkdecval())
    ...
    impl defmt::Format for Em01ctrl0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Em01ctrl0 {{ ipkval: {:?}, ipkdecval: {=u8:?}, drvspeed: {:?} }}",
                self.ipkval(),
                self.ipkdecval(),
                self.drvspeed()
            )
    ...
    impl Em23ctrl0 {
        ...
        #[doc = "EM23 dec Peak Current Setting."]
        #[must_use]
        #[inline(always)]
        pub const fn ipkdecval(&self) -> u8 {
            let val = (self.0 >> 4usize) & 0x0f;
    ...
    impl defmt::Format for Em23ctrl0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Em23ctrl0 {{ ipkval: {:?}, ipkdecval: {=u8:?}, drvspeed: {:?} }}",
                self.ipkval(),
                self.ipkdecval(),
                self.drvspeed()
            )
    ...
    impl Ien {
        ...
        #[doc = "Pulse Pairing Mode Interrupt Enable."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "Pulse Pairing Mode Interrupt Enable."]
        #[inline(always)]
        pub const fn set_ppmode(&mut self, val: bool) {
    ...
    impl defmt::Format for Ien {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ien {{ bypsw: {=bool:?}, warm: {=bool:?}, running: {=bool:?}, vreginlow: {=bool:?}, vreginhigh: {=bool:?}, regulation: {=bool:?}, tmax: {=bool:?}, em4err: {=bool:?}, ppmode: {=bool:?}, pfmxmode: {=bool:?} }}",
                self.bypsw(),
                self.warm(),
                self.running(),
                self.vreginlow(),
    ...
    impl If {
        ...
        #[doc = "Entered Pulse Pairing mode."]
        #[must_use]
        #[inline(always)]
        pub const fn ppmode(&self) -> bool {
            let val = (self.0 >> 8usize) & 0x01;
    ...
    impl defmt::Format for If {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "If {{ bypsw: {=bool:?}, warm: {=bool:?}, running: {=bool:?}, vreginlow: {=bool:?}, vreginhigh: {=bool:?}, regulation: {=bool:?}, tmax: {=bool:?}, em4err: {=bool:?}, ppmode: {=bool:?}, pfmxmode: {=bool:?} }}",
                self.bypsw(),
                self.warm(),
                self.running(),
                self.vreginlow(),
    ...
    impl Status {
        ...
        #[doc = "DCDC in pulse-pairing mode."]
        #[must_use]
        #[inline(always)]
        pub const fn ppmode(&self) -> bool {
            let val = (self.0 >> 8usize) & 0x01;
    ...
    impl defmt::Format for Status {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Status {{ bypsw: {=bool:?}, warm: {=bool:?}, running: {=bool:?}, vregin: {=bool:?}, bypcmpout: {=bool:?}, ppmode: {=bool:?}, pfmxmode: {=bool:?} }}",
                self.bypsw(),
                self.warm(),
                self.running(),
                self.vregin(),
