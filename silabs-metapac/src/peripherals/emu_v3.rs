...
pub mod regs {
    ...
    impl defmt::Format for Cmd {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cmd {{ em4unlatch: {=bool:?}, tempavgreq: {=bool:?}, em01vscale1: {=bool:?}, em01vscale2: {=bool:?}, rstcauseclr: {=bool:?}, tamperrcclr: {=bool:?} }}",
                self.em4unlatch(),
                self.tempavgreq(),
                self.em01vscale1(),
                self.em01vscale2(),
    ...
    impl defmt::Format for Rstcause {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rstcause {{ por: {=bool:?}, pin: {=bool:?}, em4: {=bool:?}, wdog0: {=bool:?}, wdog1: {=bool:?}, lockup: {=bool:?}, sysreq: {=bool:?}, dvddbod: {=bool:?}, dvddlebod: {=bool:?}, decbod: {=bool:?}, avddbod: {=bool:?}, iovdd0bod: {=bool:?}, setamper: {=bool:?}, vregin: {=bool:?} }}",
                self.por(),
                self.pin(),
                self.em4(),
                self.wdog0(),
    ...
    impl defmt::Format for Rstctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rstctrl {{ wdog0rmode: {=bool:?}, sysrmode: {=bool:?}, lockuprmode: {=bool:?}, avddbodrmode: {=bool:?}, iovdd0bodrmode: {=bool:?}, decbodrmode: {=bool:?} }}",
                self.wdog0rmode(),
                self.sysrmode(),
                self.lockuprmode(),
                self.avddbodrmode(),
