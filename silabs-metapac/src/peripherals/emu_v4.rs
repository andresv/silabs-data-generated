...
impl Emu {
    ...
    #[doc = "No Description."]
    #[inline(always)]
    pub const fn tamperrstcause(self) -> crate::common::Reg<regs::Tamperrstcause, crate::common::R> {
...
pub mod regs {
    ...
    impl Bod3sense {
        ...
        #[doc = "IOVDD0 BOD enable."]
        #[must_use]
        #[inline(always)]
        pub const fn iovdd0boden(&self) -> bool {
            let val = (self.0 >> 1usize) & 0x01;
            val != 0
        }
        #[doc = "IOVDD0 BOD enable."]
        #[inline(always)]
        pub const fn set_iovdd0boden(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        #[doc = "IOVDD1 BOD enable."]
        #[must_use]
        #[inline(always)]
        pub const fn iovdd1boden(&self) -> bool {
            let val = (self.0 >> 2usize) & 0x01;
            val != 0
        }
        #[doc = "IOVDD1 BOD enable."]
        #[inline(always)]
        pub const fn set_iovdd1boden(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
        #[doc = "IOVDD2 BOD enable."]
        #[must_use]
        #[inline(always)]
        pub const fn iovdd2boden(&self) -> bool {
            let val = (self.0 >> 3usize) & 0x01;
            val != 0
        }
        #[doc = "IOVDD2 BOD enable."]
        #[inline(always)]
        pub const fn set_iovdd2boden(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for Bod3sense {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Bod3sense")
                ...
                .field("iovdd0boden", &self.iovdd0boden())
                .field("iovdd1boden", &self.iovdd1boden())
                .field("iovdd2boden", &self.iovdd2boden())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Bod3sense {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Bod3sense {{ avddboden: {=bool:?}, iovdd0boden: {=bool:?}, iovdd1boden: {=bool:?}, iovdd2boden: {=bool:?} }}",
                self.avddboden(),
                self.iovdd0boden(),
                self.iovdd1boden(),
                self.iovdd2boden()
    ...
    impl Cmd {
        ...
        #[doc = "Tamper Reset Cause Clear."]
        #[must_use]
        #[inline(always)]
        pub const fn tamperrcclr(&self) -> bool {
            let val = (self.0 >> 18usize) & 0x01;
            val != 0
        }
        #[doc = "Tamper Reset Cause Clear."]
        #[inline(always)]
        pub const fn set_tamperrcclr(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for Cmd {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Cmd")
                ...
                .field("tamperrcclr", &self.tamperrcclr())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Cmd {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cmd {{ em4unlatch: {=bool:?}, tempavgreq: {=bool:?}, rstcauseclr: {=bool:?}, tamperrcclr: {=bool:?} }}",
                self.em4unlatch(),
                self.tempavgreq(),
                self.rstcauseclr(),
                self.tamperrcclr()
    ...
    impl defmt::Format for Ctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ctrl {{ em2dbgen: {=bool:?}, tempavgnum: {:?}, em23vscale: {:?}, flashpwrupondemand: {=bool:?} }}",
                self.em2dbgen(),
                self.tempavgnum(),
                self.em23vscale(),
    ...
    impl Ien {
        ...
        #[doc = "IOVDD0 BOD Interrupt enable."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "IOVDD1 BOD Interrupt enable."]
        #[must_use]
        #[inline(always)]
        pub const fn iovdd1bod(&self) -> bool {
            let val = (self.0 >> 18usize) & 0x01;
            val != 0
        }
        #[doc = "IOVDD1 BOD Interrupt enable."]
        #[inline(always)]
        pub const fn set_iovdd1bod(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 18usize)) | (((val as u32) & 0x01) << 18usize);
        }
        #[doc = "IOVDD2 BOD Interrupt enable."]
        #[must_use]
        #[inline(always)]
        pub const fn iovdd2bod(&self) -> bool {
            let val = (self.0 >> 19usize) & 0x01;
            val != 0
        }
        #[doc = "IOVDD2 BOD Interrupt enable."]
        #[inline(always)]
        pub const fn set_iovdd2bod(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for Ien {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ien")
                ...
                .field("iovdd1bod", &self.iovdd1bod())
                .field("iovdd2bod", &self.iovdd2bod())
    ...
    impl defmt::Format for Ien {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ien {{ avddbod: {=bool:?}, iovdd0bod: {=bool:?}, iovdd1bod: {=bool:?}, iovdd2bod: {=bool:?}, em23wakeup: {=bool:?}, tempavg: {=bool:?}, temp: {=bool:?}, templow: {=bool:?}, temphigh: {=bool:?} }}",
                self.avddbod(),
                self.iovdd0bod(),
                self.iovdd1bod(),
                self.iovdd2bod(),
    ...
    impl defmt::Format for If {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "If {{ avddbod: {=bool:?}, iovdd0bod: {=bool:?}, iovdd1bod: {=bool:?}, iovdd2bod: {=bool:?}, em23wakeup: {=bool:?}, tempavg: {=bool:?}, temp: {=bool:?}, templow: {=bool:?}, temphigh: {=bool:?} }}",
                self.avddbod(),
                self.iovdd0bod(),
                self.iovdd1bod(),
                self.iovdd2bod(),
    ...
    impl Rstcause {
        ...
        #[doc = "SE Tamper event Reset."]
        #[must_use]
        #[inline(always)]
        pub const fn setamper(&self) -> bool {
            let val = (self.0 >> 13usize) & 0x01;
            val != 0
        }
        #[doc = "SE Tamper event Reset."]
        #[inline(always)]
        pub const fn set_setamper(&mut self, val: bool) {
    ...
    impl defmt::Format for Rstcause {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rstcause {{ por: {=bool:?}, pin: {=bool:?}, em4: {=bool:?}, wdog0: {=bool:?}, wdog1: {=bool:?}, lockup: {=bool:?}, sysreq: {=bool:?}, dvddbod: {=bool:?}, dvddlebod: {=bool:?}, decbod: {=bool:?}, avddbod: {=bool:?}, iovdd0bod: {=bool:?}, iovdd1bod: {=bool:?}, setamper: {=bool:?}, iovdd2bod: {=bool:?}, vregin: {=bool:?} }}",
                self.por(),
                self.pin(),
                self.em4(),
                self.wdog0(),
    ...
    impl Rstctrl {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn iovdd1bodrmode(&self) -> bool {
            let val = (self.0 >> 8usize) & 0x01;
            val != 0
        }
        #[doc = "Enable IOVDD1 BOD reset."]
        #[inline(always)]
        pub const fn set_iovdd1bodrmode(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
        }
        #[doc = "Enable IOVDD2 BOD reset."]
        #[must_use]
        #[inline(always)]
        pub const fn iovdd2bodrmode(&self) -> bool {
            let val = (self.0 >> 9usize) & 0x01;
            val != 0
        }
        #[doc = "Enable IOVDD2 BOD reset."]
        #[inline(always)]
        pub const fn set_iovdd2bodrmode(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize);
        }
    ...
    impl core::fmt::Debug for Rstctrl {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Rstctrl")
                ...
                .field("iovdd1bodrmode", &self.iovdd1bodrmode())
                .field("iovdd2bodrmode", &self.iovdd2bodrmode())
    ...
    impl defmt::Format for Rstctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rstctrl {{ wdog0rmode: {=bool:?}, sysrmode: {=bool:?}, lockuprmode: {=bool:?}, avddbodrmode: {=bool:?}, iovdd0bodrmode: {=bool:?}, iovdd1bodrmode: {=bool:?}, iovdd2bodrmode: {=bool:?}, decbodrmode: {=bool:?} }}",
                self.wdog0rmode(),
                self.sysrmode(),
                self.lockuprmode(),
                self.avddbodrmode(),
    ...
    impl defmt::Format for Status {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Status {{ lock: {=bool:?}, firsttempdone: {=bool:?}, tempactive: {=bool:?}, tempavgactive: {=bool:?}, racactive: {=bool:?}, em4ioret: {=bool:?}, em2entered: {=bool:?} }}",
                self.lock(),
                self.firsttempdone(),
                self.tempactive(),
                self.tempavgactive(),
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct Tamperrstcause(pub u32);
    impl Tamperrstcause {
        #[doc = "Tamper reset vector."]
        #[must_use]
        #[inline(always)]
        pub const fn tamperrst(&self) -> u32 {
            let val = (self.0 >> 0usize) & 0xffff_ffff;
            val as u32
        }
        #[doc = "Tamper reset vector."]
        #[inline(always)]
        pub const fn set_tamperrst(&mut self, val: u32) {
            self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
        }
    }
    impl Default for Tamperrstcause {
        #[inline(always)]
        fn default() -> Tamperrstcause {
            Tamperrstcause(0)
        }
    }
    impl core::fmt::Debug for Tamperrstcause {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Tamperrstcause")
                .field("tamperrst", &self.tamperrst())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Tamperrstcause {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Tamperrstcause {{ tamperrst: {=u32:?} }}", self.tamperrst())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
...
pub mod vals {
    ...
    impl Pd1paretdis {
        ...
        pub const Periphnoretain: Self = Self(0x01);
        #[doc = "Bit\\[1\\]. When set, do not retain RADIO associated registers when in EM2/3."]
        pub const Radionoretain: Self = Self(0x02);
    }
    impl Pd1paretdis {
    ...
    impl core::fmt::Debug for Pd1paretdis {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            match self.0 {
                0x01 => f.write_str("Periphnoretain"),
                0x02 => f.write_str("Radionoretain"),
                other => core::write!(f, "0x{:02X}", other),
            }
        }
    }
    ...
    impl defmt::Format for Pd1paretdis {
        fn format(&self, f: defmt::Formatter) {
            match self.0 {
                0x01 => defmt::write!(f, "Periphnoretain"),
                0x02 => defmt::write!(f, "Radionoretain"),
                other => defmt::write!(f, "0x{:02X}", other),
            }
        }
    }
