...
pub mod regs {
    ...
    impl defmt::Format for Cfg1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cfg1 {{ dbghalt: {=bool:?}, ctsinv: {=bool:?}, ctsen: {=bool:?}, rtsinv: {=bool:?}, rxtimeout: {:?}, sfubrx: {=bool:?}, rxprsen: {=bool:?}, txfiw: {:?}, rtsrxfw: {:?}, rxfiw: {:?} }}",
                self.dbghalt(),
                self.ctsinv(),
                self.ctsen(),
                self.rtsinv(),
    ...
    impl defmt::Format for Ien {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ien {{ txc: {=bool:?}, txfl: {=bool:?}, rxfl: {=bool:?}, rxfull: {=bool:?}, rxof: {=bool:?}, rxuf: {=bool:?}, txof: {=bool:?}, txuf: {=bool:?}, perr: {=bool:?}, ferr: {=bool:?}, mpaf: {=bool:?}, loaderr: {=bool:?}, ccf: {=bool:?}, txidle: {=bool:?}, startf: {=bool:?}, sigf: {=bool:?}, autobauddone: {=bool:?}, rxto: {=bool:?} }}",
                self.txc(),
                self.txfl(),
                self.rxfl(),
                self.rxfull(),
    ...
    impl defmt::Format for If {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "If {{ txc: {=bool:?}, txfl: {=bool:?}, rxfl: {=bool:?}, rxfull: {=bool:?}, rxof: {=bool:?}, rxuf: {=bool:?}, txof: {=bool:?}, txuf: {=bool:?}, perr: {=bool:?}, ferr: {=bool:?}, mpaf: {=bool:?}, loaderr: {=bool:?}, ccf: {=bool:?}, txidle: {=bool:?}, startf: {=bool:?}, sigf: {=bool:?}, autobauddone: {=bool:?}, rxto: {=bool:?} }}",
                self.txc(),
                self.txfl(),
                self.rxfl(),
                self.rxfull(),
