...
pub mod regs {
    ...
    impl Cfg0 {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn osrha(&self) -> super::vals::Cfg0Osrha {
            let val = (self.0 >> 5usize) & 0x07;
            super::vals::Cfg0Osrha::from_bits(val as u8)
        }
        #[doc = "High Accuracy OSR."]
        #[inline(always)]
        pub const fn set_osrha(&mut self, val: super::vals::Cfg0Osrha) {
    ...
    impl defmt::Format for Cfg0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cfg0 {{ adcmode: {:?}, osrhs: {:?}, osrha: {:?}, analoggain: {:?}, refsel: {:?}, digavg: {:?}, twoscompl: {:?} }}",
                self.adcmode(),
                self.osrhs(),
                self.osrha(),
                self.analoggain(),
    ...
    impl Cfg1 {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn osrha(&self) -> super::vals::Cfg1Osrha {
            let val = (self.0 >> 5usize) & 0x07;
            super::vals::Cfg1Osrha::from_bits(val as u8)
        }
        #[doc = "High Accuracy OSR."]
        #[inline(always)]
        pub const fn set_osrha(&mut self, val: super::vals::Cfg1Osrha) {
            self.0 = (self.0 & !(0x07 << 5usize)) | (((val.to_bits() as u32) & 0x07) << 5usize);
        }
        #[doc = "Analog Gain."]
        #[must_use]
    ...
    impl defmt::Format for Cfg1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cfg1 {{ adcmode: {:?}, osrhs: {:?}, osrha: {:?}, analoggain: {:?}, refsel: {:?}, digavg: {:?}, twoscompl: {:?} }}",
                self.adcmode(),
                self.osrhs(),
                self.osrha(),
                self.analoggain(),
...
pub mod vals {
    ...
    pub enum Cfg0Adcmode {
        ...
        Normal = 0x0,
        #[doc = "Double high speed mode with a maximum ADC_CLK of 20 MHz. Power consumption is boosted to allow faster conversions."]
        Highspeed = 0x01,
        #[doc = "High accuracy mode with maximum ADC_CLK of 5 MHz."]
        Highaccuracy = 0x02,
        _RESERVED_3 = 0x03,
    }
    impl Cfg0Adcmode {
    ...
    impl Cfg0Osrha {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Cfg0Osrha {
            unsafe { core::mem::transmute(val & 0x07) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for Cfg0Osrha {
        #[inline(always)]
        fn from(val: u8) -> Cfg0Osrha {
            Cfg0Osrha::from_bits(val)
        }
    }
    impl From<Cfg0Osrha> for u8 {
        #[inline(always)]
        fn from(val: Cfg0Osrha) -> u8 {
            Cfg0Osrha::to_bits(val)
        }
    }
    #[repr(u8)]
    #[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Cfg1Osrha {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Cfg1Osrha {
            unsafe { core::mem::transmute(val & 0x07) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for Cfg1Osrha {
        #[inline(always)]
        fn from(val: u8) -> Cfg1Osrha {
            Cfg1Osrha::from_bits(val)
        }
    }
    impl From<Cfg1Osrha> for u8 {
        #[inline(always)]
        fn from(val: Cfg1Osrha) -> u8 {
            Cfg1Osrha::to_bits(val)
        }
    }
    #[repr(u8)]
    #[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
