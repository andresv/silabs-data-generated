...
pub mod regs {
    ...
    impl defmt::Format for Ch0Cfg {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ch0Cfg {{ arbslots: {:?}, srcincsign: {:?}, dstincsign: {:?} }}",
                self.arbslots(),
                self.srcincsign(),
                self.dstincsign()
            )
    ...
    impl Ch0Ctrl {
        ...
        #[doc = "DMA Operation Done Interrupt Flag Set En."]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for Ch0Ctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ch0Ctrl {{ structtype: {:?}, structreq: {=bool:?}, xfercnt: {=u16:?}, byteswap: {=bool:?}, blocksize: {:?}, doneien: {=bool:?}, reqmode: {:?}, decloopcnt: {=bool:?}, ignoresreq: {=bool:?}, srcinc: {:?}, size: {:?}, dstinc: {:?}, srcmode: {:?}, dstmode: {:?} }}",
                self.structtype(),
                self.structreq(),
                self.xfercnt(),
                self.byteswap(),
    ...
    impl core::fmt::Debug for Ch0Dst {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ch0Dst").field("dstaddr", &self.dstaddr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ch0Dst {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ch0Dst {{ dstaddr: {=u32:?} }}", self.dstaddr())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl core::fmt::Debug for Ch0Src {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ch0Src").field("srcaddr", &self.srcaddr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ch0Src {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ch0Src {{ srcaddr: {=u32:?} }}", self.srcaddr())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl defmt::Format for Ch1Cfg {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ch1Cfg {{ arbslots: {:?}, srcincsign: {:?}, dstincsign: {:?} }}",
                self.arbslots(),
                self.srcincsign(),
                self.dstincsign()
            )
    ...
    impl defmt::Format for Ch1Ctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ch1Ctrl {{ structtype: {:?}, structreq: {=bool:?}, xfercnt: {=u16:?}, byteswap: {=bool:?}, blocksize: {:?}, doneien: {=bool:?}, reqmode: {:?}, decloopcnt: {=bool:?}, ignoresreq: {=bool:?}, srcinc: {:?}, size: {:?}, dstinc: {:?}, srcmode: {:?}, dstmode: {:?} }}",
                self.structtype(),
                self.structreq(),
                self.xfercnt(),
                self.byteswap(),
    ...
    impl core::fmt::Debug for Ch1Dst {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ch1Dst").field("dstaddr", &self.dstaddr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ch1Dst {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ch1Dst {{ dstaddr: {=u32:?} }}", self.dstaddr())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl core::fmt::Debug for Ch1Src {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ch1Src").field("srcaddr", &self.srcaddr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ch1Src {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ch1Src {{ srcaddr: {=u32:?} }}", self.srcaddr())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl defmt::Format for Ch2Cfg {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ch2Cfg {{ arbslots: {:?}, srcincsign: {:?}, dstincsign: {:?} }}",
                self.arbslots(),
                self.srcincsign(),
                self.dstincsign()
            )
    ...
    impl defmt::Format for Ch2Ctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ch2Ctrl {{ structtype: {:?}, structreq: {=bool:?}, xfercnt: {=u16:?}, byteswap: {=bool:?}, blocksize: {:?}, doneien: {=bool:?}, reqmode: {:?}, decloopcnt: {=bool:?}, ignoresreq: {=bool:?}, srcinc: {:?}, size: {:?}, dstinc: {:?}, srcmode: {:?}, dstmode: {:?} }}",
                self.structtype(),
                self.structreq(),
                self.xfercnt(),
                self.byteswap(),
    ...
    impl core::fmt::Debug for Ch2Dst {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ch2Dst").field("dstaddr", &self.dstaddr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ch2Dst {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ch2Dst {{ dstaddr: {=u32:?} }}", self.dstaddr())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl core::fmt::Debug for Ch2Src {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ch2Src").field("srcaddr", &self.srcaddr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ch2Src {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ch2Src {{ srcaddr: {=u32:?} }}", self.srcaddr())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl defmt::Format for Ch3Cfg {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ch3Cfg {{ arbslots: {:?}, srcincsign: {:?}, dstincsign: {:?} }}",
                self.arbslots(),
                self.srcincsign(),
                self.dstincsign()
            )
    ...
    impl defmt::Format for Ch3Ctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ch3Ctrl {{ structtype: {:?}, structreq: {=bool:?}, xfercnt: {=u16:?}, byteswap: {=bool:?}, blocksize: {:?}, doneien: {=bool:?}, reqmode: {:?}, decloopcnt: {=bool:?}, ignoresreq: {=bool:?}, srcinc: {:?}, size: {:?}, dstinc: {:?}, srcmode: {:?}, dstmode: {:?} }}",
                self.structtype(),
                self.structreq(),
                self.xfercnt(),
                self.byteswap(),
    ...
    impl core::fmt::Debug for Ch3Dst {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ch3Dst").field("dstaddr", &self.dstaddr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ch3Dst {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ch3Dst {{ dstaddr: {=u32:?} }}", self.dstaddr())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl core::fmt::Debug for Ch3Src {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ch3Src").field("srcaddr", &self.srcaddr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ch3Src {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ch3Src {{ srcaddr: {=u32:?} }}", self.srcaddr())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl defmt::Format for Ch4Cfg {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ch4Cfg {{ arbslots: {:?}, srcincsign: {:?}, dstincsign: {:?} }}",
                self.arbslots(),
                self.srcincsign(),
                self.dstincsign()
            )
    ...
    impl defmt::Format for Ch4Ctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ch4Ctrl {{ structtype: {:?}, structreq: {=bool:?}, xfercnt: {=u16:?}, byteswap: {=bool:?}, blocksize: {:?}, doneien: {=bool:?}, reqmode: {:?}, decloopcnt: {=bool:?}, ignoresreq: {=bool:?}, srcinc: {:?}, size: {:?}, dstinc: {:?}, srcmode: {:?}, dstmode: {:?} }}",
                self.structtype(),
                self.structreq(),
                self.xfercnt(),
                self.byteswap(),
    ...
    impl core::fmt::Debug for Ch4Dst {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ch4Dst").field("dstaddr", &self.dstaddr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ch4Dst {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ch4Dst {{ dstaddr: {=u32:?} }}", self.dstaddr())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl core::fmt::Debug for Ch4Src {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ch4Src").field("srcaddr", &self.srcaddr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ch4Src {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ch4Src {{ srcaddr: {=u32:?} }}", self.srcaddr())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl defmt::Format for Ch5Cfg {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ch5Cfg {{ arbslots: {:?}, srcincsign: {:?}, dstincsign: {:?} }}",
                self.arbslots(),
                self.srcincsign(),
                self.dstincsign()
            )
    ...
    impl defmt::Format for Ch5Ctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ch5Ctrl {{ structtype: {:?}, structreq: {=bool:?}, xfercnt: {=u16:?}, byteswap: {=bool:?}, blocksize: {:?}, doneien: {=bool:?}, reqmode: {:?}, decloopcnt: {=bool:?}, ignoresreq: {=bool:?}, srcinc: {:?}, size: {:?}, dstinc: {:?}, srcmode: {:?}, dstmode: {:?} }}",
                self.structtype(),
                self.structreq(),
                self.xfercnt(),
                self.byteswap(),
    ...
    impl core::fmt::Debug for Ch5Dst {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ch5Dst").field("dstaddr", &self.dstaddr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ch5Dst {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ch5Dst {{ dstaddr: {=u32:?} }}", self.dstaddr())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl core::fmt::Debug for Ch5Src {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ch5Src").field("srcaddr", &self.srcaddr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ch5Src {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ch5Src {{ srcaddr: {=u32:?} }}", self.srcaddr())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl defmt::Format for Ch6Cfg {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ch6Cfg {{ arbslots: {:?}, srcincsign: {:?}, dstincsign: {:?} }}",
                self.arbslots(),
                self.srcincsign(),
                self.dstincsign()
            )
    ...
    impl defmt::Format for Ch6Ctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ch6Ctrl {{ structtype: {:?}, structreq: {=bool:?}, xfercnt: {=u16:?}, byteswap: {=bool:?}, blocksize: {:?}, doneien: {=bool:?}, reqmode: {:?}, decloopcnt: {=bool:?}, ignoresreq: {=bool:?}, srcinc: {:?}, size: {:?}, dstinc: {:?}, srcmode: {:?}, dstmode: {:?} }}",
                self.structtype(),
                self.structreq(),
                self.xfercnt(),
                self.byteswap(),
    ...
    impl core::fmt::Debug for Ch6Dst {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ch6Dst").field("dstaddr", &self.dstaddr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ch6Dst {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ch6Dst {{ dstaddr: {=u32:?} }}", self.dstaddr())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl core::fmt::Debug for Ch6Src {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ch6Src").field("srcaddr", &self.srcaddr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ch6Src {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ch6Src {{ srcaddr: {=u32:?} }}", self.srcaddr())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl defmt::Format for Ch7Cfg {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ch7Cfg {{ arbslots: {:?}, srcincsign: {:?}, dstincsign: {:?} }}",
                self.arbslots(),
                self.srcincsign(),
                self.dstincsign()
            )
    ...
    impl defmt::Format for Ch7Ctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ch7Ctrl {{ structtype: {:?}, structreq: {=bool:?}, xfercnt: {=u16:?}, byteswap: {=bool:?}, blocksize: {:?}, doneien: {=bool:?}, reqmode: {:?}, decloopcnt: {=bool:?}, ignoresreq: {=bool:?}, srcinc: {:?}, size: {:?}, dstinc: {:?}, srcmode: {:?}, dstmode: {:?} }}",
                self.structtype(),
                self.structreq(),
                self.xfercnt(),
                self.byteswap(),
    ...
    impl core::fmt::Debug for Ch7Dst {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ch7Dst").field("dstaddr", &self.dstaddr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ch7Dst {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ch7Dst {{ dstaddr: {=u32:?} }}", self.dstaddr())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl core::fmt::Debug for Ch7Src {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ch7Src").field("srcaddr", &self.srcaddr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Ch7Src {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ch7Src {{ srcaddr: {=u32:?} }}", self.srcaddr())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl Chdis {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn chdis(&self) -> u8 {
            let val = (self.0 >> 0usize) & 0xff;
            val as u8
        }
        #[doc = "DMA Channel disable."]
        #[inline(always)]
        pub const fn set_chdis(&mut self, val: u8) {
            self.0 = (self.0 & !(0xff << 0usize)) | (((val as u32) & 0xff) << 0usize);
        }
    }
    ...
    impl defmt::Format for Chdis {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Chdis {{ chdis: {=u8:?} }}", self.chdis())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl Chdone {
        #[doc = "DMA Channel Link done intr flag."]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for Chdone {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Chdone {{ chdone0: {=bool:?}, chdone1: {=bool:?}, chdone2: {=bool:?}, chdone3: {=bool:?}, chdone4: {=bool:?}, chdone5: {=bool:?}, chdone6: {=bool:?}, chdone7: {=bool:?} }}",
                self.chdone0(),
                self.chdone1(),
                self.chdone2(),
                self.chdone3(),
    ...
    impl Chstatus {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn chstatus(&self) -> u8 {
            let val = (self.0 >> 0usize) & 0xff;
            val as u8
        }
        #[doc = "DMA Channel Status."]
        #[inline(always)]
        pub const fn set_chstatus(&mut self, val: u8) {
            self.0 = (self.0 & !(0xff << 0usize)) | (((val as u32) & 0xff) << 0usize);
        }
    }
    ...
    impl defmt::Format for Chstatus {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Chstatus {{ chstatus: {=u8:?} }}", self.chstatus())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl En {
        #[doc = "LDMA module enable and disable register."]
        #[must_use]
        #[inline(always)]
    ...
    impl Ien {
        #[doc = "Enable or disable the done interrupt."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "Enable or disable the error interrupt."]
        #[must_use]
        #[inline(always)]
    ...
    impl If {
        #[doc = "DMA Structure Operation Done."]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for If {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "If {{ done0: {=bool:?}, done1: {=bool:?}, done2: {=bool:?}, done3: {=bool:?}, done4: {=bool:?}, done5: {=bool:?}, done6: {=bool:?}, done7: {=bool:?}, error: {=bool:?} }}",
                self.done0(),
                self.done1(),
                self.done2(),
                self.done3(),
    ...
    impl defmt::Format for Status {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Status {{ anybusy: {=bool:?}, anyreq: {=bool:?}, chgrant: {=u8:?}, cherror: {=u8:?}, fifolevel: {=u8:?}, chnum: {=u8:?} }}",
                self.anybusy(),
                self.anyreq(),
                self.chgrant(),
                self.cherror(),
