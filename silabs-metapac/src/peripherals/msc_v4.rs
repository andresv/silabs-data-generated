...
impl Msc {
    ...
    #[doc = "No Description."]
    #[inline(always)]
    pub const fn pagelock6(self) -> crate::common::Reg<regs::Pagelock6, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0138usize) as _) }
    }
    #[doc = "No Description."]
    #[inline(always)]
    pub const fn pagelock7(self) -> crate::common::Reg<regs::Pagelock7, crate::common::RW> {
    ...
    #[doc = "No Description. (write-1-to-set alias)"]
    #[inline(always)]
    pub const fn pagelock6_set(self) -> crate::common::Reg<regs::Pagelock6, crate::common::W> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x1138usize) as _) }
    }
    #[doc = "No Description. (write-1-to-set alias)"]
    #[inline(always)]
    pub const fn pagelock7_set(self) -> crate::common::Reg<regs::Pagelock7, crate::common::W> {
    ...
    #[doc = "No Description. (write-1-to-clr alias)"]
    #[inline(always)]
    pub const fn pagelock6_clr(self) -> crate::common::Reg<regs::Pagelock6, crate::common::W> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x2138usize) as _) }
    }
    #[doc = "No Description. (write-1-to-clr alias)"]
    #[inline(always)]
    pub const fn pagelock7_clr(self) -> crate::common::Reg<regs::Pagelock7, crate::common::W> {
    ...
    #[doc = "No Description. (write-1-to-tgl alias)"]
    #[inline(always)]
    pub const fn pagelock6_tgl(self) -> crate::common::Reg<regs::Pagelock6, crate::common::W> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x3138usize) as _) }
    }
    #[doc = "No Description. (write-1-to-tgl alias)"]
    #[inline(always)]
    pub const fn pagelock7_tgl(self) -> crate::common::Reg<regs::Pagelock7, crate::common::W> {
...
pub mod regs {
    ...
    impl Default for Pagelock6 {
        #[inline(always)]
        fn default() -> Pagelock6 {
            Pagelock6(0)
        }
    }
    impl core::fmt::Debug for Pagelock6 {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Pagelock6").field("lockbit", &self.lockbit()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Pagelock6 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Pagelock6 {{ lockbit: {=u32:?} }}", self.lockbit())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct Pagelock7(pub u32);
    impl Pagelock7 {
        #[doc = "page lock bit."]
        #[must_use]
        #[inline(always)]
    ...
    impl Default for Pagelock7 {
        #[inline(always)]
        fn default() -> Pagelock7 {
            Pagelock7(0)
        }
    }
    impl core::fmt::Debug for Pagelock7 {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Pagelock7").field("lockbit", &self.lockbit()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Pagelock7 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Pagelock7 {{ lockbit: {=u32:?} }}", self.lockbit())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
