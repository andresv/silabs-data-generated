...
impl Rtcc {
    ...
    #[doc = "No Description."]
    #[inline(always)]
    pub const fn cc2_ocvalue(self) -> crate::common::Reg<regs::Cc2Ocvalue, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x4cusize) as _) }
    }
    #[doc = "No Description."]
    #[inline(always)]
    pub const fn cc2_icvalue(self) -> crate::common::Reg<regs::Cc2Icvalue, crate::common::R> {
    ...
    #[doc = "No Description. (write-1-to-set alias)"]
    #[inline(always)]
    pub const fn cc0_ocvalue_set(self) -> crate::common::Reg<regs::Cc0Ocvalue, crate::common::W> {
    ...
    #[doc = "No Description. (write-1-to-set alias)"]
    #[inline(always)]
    pub const fn cc1_ocvalue_set(self) -> crate::common::Reg<regs::Cc1Ocvalue, crate::common::W> {
    ...
    #[doc = "No Description. (write-1-to-set alias)"]
    #[inline(always)]
    pub const fn cc2_ocvalue_set(self) -> crate::common::Reg<regs::Cc2Ocvalue, crate::common::W> {
    ...
    #[doc = "No Description. (write-1-to-clr alias)"]
    #[inline(always)]
    pub const fn cc0_ocvalue_clr(self) -> crate::common::Reg<regs::Cc0Ocvalue, crate::common::W> {
    ...
    #[doc = "No Description. (write-1-to-clr alias)"]
    #[inline(always)]
    pub const fn cc1_ocvalue_clr(self) -> crate::common::Reg<regs::Cc1Ocvalue, crate::common::W> {
    ...
    #[doc = "No Description. (write-1-to-clr alias)"]
    #[inline(always)]
    pub const fn cc2_ocvalue_clr(self) -> crate::common::Reg<regs::Cc2Ocvalue, crate::common::W> {
    ...
    #[doc = "No Description. (write-1-to-tgl alias)"]
    #[inline(always)]
    pub const fn cc0_ocvalue_tgl(self) -> crate::common::Reg<regs::Cc0Ocvalue, crate::common::W> {
    ...
    #[doc = "No Description. (write-1-to-tgl alias)"]
    #[inline(always)]
    pub const fn cc1_ocvalue_tgl(self) -> crate::common::Reg<regs::Cc1Ocvalue, crate::common::W> {
    ...
    #[doc = "No Description. (write-1-to-tgl alias)"]
    #[inline(always)]
    pub const fn cc2_ocvalue_tgl(self) -> crate::common::Reg<regs::Cc2Ocvalue, crate::common::W> {
...
pub mod regs {
    ...
    impl Cc2Ctrl {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn mode(&self) -> super::vals::Cc2CtrlMode {
            let val = (self.0 >> 0usize) & 0x03;
            super::vals::Cc2CtrlMode::from_bits(val as u8)
        }
        #[doc = "CC Channel Mode."]
        #[inline(always)]
        pub const fn set_mode(&mut self, val: super::vals::Cc2CtrlMode) {
            self.0 = (self.0 & !(0x03 << 0usize)) | (((val.to_bits() as u32) & 0x03) << 0usize);
        }
        #[doc = "Compare Match Output Action."]
        #[must_use]
        ...
        #[must_use]
        #[inline(always)]
        pub const fn compbase(&self) -> super::vals::Cc2CtrlCompbase {
            let val = (self.0 >> 4usize) & 0x01;
            super::vals::Cc2CtrlCompbase::from_bits(val as u8)
        }
        #[doc = "Capture compare channel comparison base."]
        #[inline(always)]
        pub const fn set_compbase(&mut self, val: super::vals::Cc2CtrlCompbase) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
        }
        #[doc = "Input Capture Edge Select."]
        #[must_use]
    ...
    impl defmt::Format for Cc2Ctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cc2Ctrl {{ mode: {:?}, cmoa: {:?}, compbase: {:?}, icedge: {:?} }}",
                self.mode(),
                self.cmoa(),
                self.compbase(),
                self.icedge()
    ...
    impl Default for Cc2Icvalue {
        #[inline(always)]
        fn default() -> Cc2Icvalue {
            Cc2Icvalue(0)
        }
    }
    impl core::fmt::Debug for Cc2Icvalue {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Cc2Icvalue").field("ic", &self.ic()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Cc2Icvalue {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Cc2Icvalue {{ ic: {=u32:?} }}", self.ic())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct Cc2Ocvalue(pub u32);
    impl Cc2Ocvalue {
        #[doc = "Output Compare Value."]
        #[must_use]
        #[inline(always)]
    ...
    impl Default for Cc2Ocvalue {
        #[inline(always)]
        fn default() -> Cc2Ocvalue {
            Cc2Ocvalue(0)
        }
    }
    impl core::fmt::Debug for Cc2Ocvalue {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Cc2Ocvalue").field("oc", &self.oc()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Cc2Ocvalue {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Cc2Ocvalue {{ oc: {=u32:?} }}", self.oc())
        }
    }
    #[doc = "No Description."]
    #[repr(transparent)]
    ...
    impl defmt::Format for Ien {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ien {{ of: {=bool:?}, cnttick: {=bool:?}, cc0: {=bool:?}, cc1: {=bool:?}, cc2: {=bool:?} }}",
                self.of(),
                self.cnttick(),
                self.cc0(),
                self.cc1(),
    ...
    impl defmt::Format for If {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "If {{ of: {=bool:?}, cnttick: {=bool:?}, cc0: {=bool:?}, cc1: {=bool:?}, cc2: {=bool:?} }}",
                self.of(),
                self.cnttick(),
                self.cc0(),
                self.cc1(),
...
pub mod vals {
    ...
    #[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
    #[cfg_attr(feature = "defmt", derive(defmt::Format))]
    pub enum Cc2CtrlCompbase {
        #[doc = "RTCC_CCx_ICVALUE/OCVALUE is compared with CNT register."]
        Cnt = 0x0,
        #[doc = "Least significant bits of RTCC_CCx_ICVALUE/OCVALUE are compared with COMBCNT."]
        Precnt = 0x01,
    }
    impl Cc2CtrlCompbase {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Cc2CtrlCompbase {
            unsafe { core::mem::transmute(val & 0x01) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for Cc2CtrlCompbase {
        #[inline(always)]
        fn from(val: u8) -> Cc2CtrlCompbase {
            Cc2CtrlCompbase::from_bits(val)
        }
    }
    impl From<Cc2CtrlCompbase> for u8 {
        #[inline(always)]
        fn from(val: Cc2CtrlCompbase) -> u8 {
            Cc2CtrlCompbase::to_bits(val)
        }
    }
    #[repr(u8)]
    #[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
