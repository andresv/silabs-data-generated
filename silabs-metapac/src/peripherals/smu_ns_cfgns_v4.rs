...
pub mod regs {
    ...
    impl defmt::Format for Bmpunspatd0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Bmpunspatd0 {{ radioaes: {=bool:?}, radiosubsystem: {=bool:?}, bufc: {=bool:?}, ldma0: {=bool:?}, ldma1: {=bool:?}, rfeca0: {=bool:?}, rfeca1: {=bool:?}, rfldma: {=bool:?}, seextdma: {=bool:?}, usb: {=bool:?} }}",
                self.radioaes(),
                self.radiosubsystem(),
                self.bufc(),
                self.ldma0(),
