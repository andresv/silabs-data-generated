...
pub mod regs {
    ...
    impl defmt::Format for Bmpunspatd0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Bmpunspatd0 {{ radioaes: {=bool:?}, radiosubsystem: {=bool:?}, ldma: {=bool:?}, mvpahbdata0: {=bool:?}, mvpahbdata1: {=bool:?}, mvpahbdata2: {=bool:?}, rfeca0: {=bool:?}, rfeca1: {=bool:?}, seextdma: {=bool:?} }}",
                self.radioaes(),
                self.radiosubsystem(),
                self.ldma(),
                self.mvpahbdata0(),
    ...
    impl defmt::Format for Ppunspatd0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ppunspatd0 {{ scratchpad: {=bool:?}, emu: {=bool:?}, cmu: {=bool:?}, hfrco0: {=bool:?}, fsrco: {=bool:?}, dpll0: {=bool:?}, lfxo: {=bool:?}, lfrco: {=bool:?}, ulfrco: {=bool:?}, msc: {=bool:?}, icache0: {=bool:?}, prs: {=bool:?}, gpio: {=bool:?}, ldma: {=bool:?}, ldmaxbar: {=bool:?}, timer0: {=bool:?}, timer1: {=bool:?}, timer2: {=bool:?}, timer3: {=bool:?}, timer4: {=bool:?}, usart0: {=bool:?}, burtc: {=bool:?}, i2c1: {=bool:?}, chiptestctrl: {=bool:?}, syscfgcfgns: {=bool:?}, syscfg: {=bool:?}, buram: {=bool:?}, gpcrc: {=bool:?}, dcdc: {=bool:?}, hostmailbox: {=bool:?}, eusart1: {=bool:?}, sysrtc: {=bool:?} }}",
                self.scratchpad(),
                self.emu(),
                self.cmu(),
                self.hfrco0(),
    ...
    impl defmt::Format for Ppunspatd1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ppunspatd1 {{ keyscan: {=bool:?}, dmem: {=bool:?}, radioaes: {=bool:?}, smu: {=bool:?}, smucfgns: {=bool:?}, letimer0: {=bool:?}, iadc0: {=bool:?}, acmp0: {=bool:?}, acmp1: {=bool:?}, amuxcp0: {=bool:?}, vdac0: {=bool:?}, vdac1: {=bool:?}, pcnt: {=bool:?}, hfrco1: {=bool:?}, hfxo0: {=bool:?}, i2c0: {=bool:?}, wdog0: {=bool:?}, wdog1: {=bool:?}, eusart0: {=bool:?}, semailbox: {=bool:?}, mvp: {=bool:?}, ahbradio: {=bool:?} }}",
                self.keyscan(),
                self.dmem(),
                self.radioaes(),
                self.smu(),
