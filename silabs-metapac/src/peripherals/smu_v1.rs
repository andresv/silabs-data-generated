...
impl Smu {
    ...
    #[doc = "Access to Lock/unlock the SMU Configuration. (write-1-to-set alias)"]
    #[inline(always)]
    ...
    #[doc = "Read to get status of SMU interrupts. (write-1-to-set alias)"]
    #[inline(always)]
    ...
    #[doc = "Write to Enable/Disable SMU interrupts. (write-1-to-set alias)"]
    #[inline(always)]
    ...
    #[doc = "Write to specify if a region is secure or non-secure. (write-1-to-set alias)"]
    #[inline(always)]
    ...
    #[doc = "Specify the boundary between regions 0 and 1. (write-1-to-set alias)"]
    #[inline(always)]
    ...
    #[doc = "Specify the boundary between regions 1 and 2. (write-1-to-set alias)"]
    #[inline(always)]
    ...
    #[doc = "Specify the boundary between regions 4 and 5. (write-1-to-set alias)"]
    #[inline(always)]
    ...
    #[doc = "Specify the boundary between regions 5 and 6. (write-1-to-set alias)"]
    #[inline(always)]
    ...
    #[doc = "Access to Lock/unlock the SMU Configuration. (write-1-to-clr alias)"]
    #[inline(always)]
    ...
    #[doc = "Read to get status of SMU interrupts. (write-1-to-clr alias)"]
    #[inline(always)]
    ...
    #[doc = "Write to Enable/Disable SMU interrupts. (write-1-to-clr alias)"]
    #[inline(always)]
    ...
    #[doc = "Write to specify if a region is secure or non-secure. (write-1-to-clr alias)"]
    #[inline(always)]
    ...
    #[doc = "Specify the boundary between regions 0 and 1. (write-1-to-clr alias)"]
    #[inline(always)]
    ...
    #[doc = "Specify the boundary between regions 1 and 2. (write-1-to-clr alias)"]
    #[inline(always)]
    ...
    #[doc = "Specify the boundary between regions 4 and 5. (write-1-to-clr alias)"]
    #[inline(always)]
    ...
    #[doc = "Specify the boundary between regions 5 and 6. (write-1-to-clr alias)"]
    #[inline(always)]
    ...
    #[doc = "Access to Lock/unlock the SMU Configuration. (write-1-to-tgl alias)"]
    #[inline(always)]
    ...
    #[doc = "Read to get status of SMU interrupts. (write-1-to-tgl alias)"]
    #[inline(always)]
    ...
    #[doc = "Write to Enable/Disable SMU interrupts. (write-1-to-tgl alias)"]
    #[inline(always)]
    ...
    #[doc = "Write to specify if a region is secure or non-secure. (write-1-to-tgl alias)"]
    #[inline(always)]
    ...
    #[doc = "Specify the boundary between regions 0 and 1. (write-1-to-tgl alias)"]
    #[inline(always)]
    ...
    #[doc = "Specify the boundary between regions 1 and 2. (write-1-to-tgl alias)"]
    #[inline(always)]
    ...
    #[doc = "Specify the boundary between regions 4 and 5. (write-1-to-tgl alias)"]
    #[inline(always)]
    ...
    #[doc = "Specify the boundary between regions 5 and 6. (write-1-to-tgl alias)"]
    #[inline(always)]
...
pub mod regs {
    ...
    impl defmt::Format for Bmpupatd0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Bmpupatd0 {{ radioaes: {=bool:?}, cryptoacc: {=bool:?}, radiosubsystem: {=bool:?}, radioifadcdebug: {=bool:?}, ldma: {=bool:?} }}",
                self.radioaes(),
                self.cryptoacc(),
                self.radiosubsystem(),
    ...
    impl Bmpusatd0 {
        ...
        #[doc = "RADIO IFADC debug secure mode."]
        #[must_use]
        #[inline(always)]
        pub const fn radioifadcdebug(&self) -> bool {
            let val = (self.0 >> 3usize) & 0x01;
    ...
    impl defmt::Format for Bmpusatd0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Bmpusatd0 {{ radioaes: {=bool:?}, cryptoacc: {=bool:?}, radiosubsystem: {=bool:?}, radioifadcdebug: {=bool:?}, ldma: {=bool:?} }}",
                self.radioaes(),
                self.cryptoacc(),
                self.radiosubsystem(),
                self.radioifadcdebug(),
    ...
    impl Esaumrb01 {
        #[doc = "Moveable Region Boundary 0-1."]
        #[must_use]
        #[inline(always)]
    ...
    impl Esaumrb12 {
        #[doc = "Moveable Region Boundary 1-2."]
        #[must_use]
        #[inline(always)]
    ...
    impl Esaumrb45 {
        #[doc = "Moveable Region Boundary 4-5."]
        #[must_use]
        #[inline(always)]
    ...
    impl Esaumrb56 {
        #[doc = "Moveable Region Boundary 5-6."]
        #[must_use]
        #[inline(always)]
    ...
    impl M33ctrl {
        #[doc = "LOCKSVTAIRCR control of M33 CPU."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "LOCKNSVTOR control of M33 CPU."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "LOCKSMPU control of M33 CPU."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "LOCKNSMPU control of M33 CPU."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "LOCKSAU control of M33 CPU."]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for Ppupatd0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ppupatd0 {{ emu: {=bool:?}, cmu: {=bool:?}, hfxo0: {=bool:?}, hfrco0: {=bool:?}, fsrco: {=bool:?}, dpll0: {=bool:?}, lfxo: {=bool:?}, lfrco: {=bool:?}, ulfrco: {=bool:?}, msc: {=bool:?}, icache0: {=bool:?}, prs: {=bool:?}, gpio: {=bool:?}, ldma: {=bool:?}, ldmaxbar: {=bool:?}, timer0: {=bool:?}, timer1: {=bool:?}, timer2: {=bool:?}, timer3: {=bool:?}, timer4: {=bool:?}, usart0: {=bool:?}, usart1: {=bool:?}, burtc: {=bool:?}, i2c1: {=bool:?}, chiptestctrl: {=bool:?}, syscfgcfgns: {=bool:?}, syscfg: {=bool:?}, buram: {=bool:?}, ifadcdebug: {=bool:?}, gpcrc: {=bool:?}, dci: {=bool:?} }}",
                self.emu(),
                self.cmu(),
                self.hfxo0(),
                self.hfrco0(),
    ...
    impl defmt::Format for Ppupatd1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ppupatd1 {{ dcdc: {=bool:?}, pdm: {=bool:?}, rfsense: {=bool:?}, radioaes: {=bool:?}, smu: {=bool:?}, smucfgns: {=bool:?}, rtcc: {=bool:?}, letimer0: {=bool:?}, iadc0: {=bool:?}, i2c0: {=bool:?}, wdog0: {=bool:?}, amuxcp0: {=bool:?}, euart0: {=bool:?}, cryptoacc: {=bool:?}, ahbradio: {=bool:?} }}",
                self.dcdc(),
                self.pdm(),
                self.rfsense(),
                self.radioaes(),
    ...
    impl defmt::Format for Ppusatd0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ppusatd0 {{ emu: {=bool:?}, cmu: {=bool:?}, hfxo0: {=bool:?}, hfrco0: {=bool:?}, fsrco: {=bool:?}, dpll0: {=bool:?}, lfxo: {=bool:?}, lfrco: {=bool:?}, ulfrco: {=bool:?}, msc: {=bool:?}, icache0: {=bool:?}, prs: {=bool:?}, gpio: {=bool:?}, ldma: {=bool:?}, ldmaxbar: {=bool:?}, timer0: {=bool:?}, timer1: {=bool:?}, timer2: {=bool:?}, timer3: {=bool:?}, timer4: {=bool:?}, usart0: {=bool:?}, usart1: {=bool:?}, burtc: {=bool:?}, i2c1: {=bool:?}, chiptestctrl: {=bool:?}, syscfgcfgns: {=bool:?}, syscfg: {=bool:?}, buram: {=bool:?}, ifadcdebug: {=bool:?}, gpcrc: {=bool:?}, dci: {=bool:?} }}",
                self.emu(),
                self.cmu(),
                self.hfxo0(),
                self.hfrco0(),
    ...
    impl defmt::Format for Ppusatd1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ppusatd1 {{ dcdc: {=bool:?}, pdm: {=bool:?}, rfsense: {=bool:?}, radioaes: {=bool:?}, smu: {=bool:?}, smucfgns: {=bool:?}, rtcc: {=bool:?}, letimer0: {=bool:?}, iadc0: {=bool:?}, i2c0: {=bool:?}, wdog0: {=bool:?}, amuxcp0: {=bool:?}, euart0: {=bool:?}, cryptoacc: {=bool:?}, ahbradio: {=bool:?} }}",
                self.dcdc(),
                self.pdm(),
                self.rfsense(),
                self.radioaes(),
