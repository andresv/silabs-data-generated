...
pub mod regs {
    ...
    impl defmt::Format for Ppupatd1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ppupatd1 {{ keyscan: {=bool:?}, dmem: {=bool:?}, radioaes: {=bool:?}, smu: {=bool:?}, smucfgns: {=bool:?}, letimer0: {=bool:?}, iadc0: {=bool:?}, acmp0: {=bool:?}, acmp1: {=bool:?}, amuxcp0: {=bool:?}, vdac0: {=bool:?}, vdac1: {=bool:?}, pcnt: {=bool:?}, hfrco1: {=bool:?}, hfxo0: {=bool:?}, i2c0: {=bool:?}, wdog0: {=bool:?}, wdog1: {=bool:?}, eusart0: {=bool:?}, semailbox: {=bool:?}, ahbradio: {=bool:?} }}",
                self.keyscan(),
                self.dmem(),
                self.radioaes(),
                self.smu(),
    ...
    impl defmt::Format for Ppusatd1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ppusatd1 {{ keyscan: {=bool:?}, dmem: {=bool:?}, radioaes: {=bool:?}, smu: {=bool:?}, smucfgns: {=bool:?}, letimer0: {=bool:?}, iadc0: {=bool:?}, acmp0: {=bool:?}, acmp1: {=bool:?}, amuxcp0: {=bool:?}, vdac0: {=bool:?}, vdac1: {=bool:?}, pcnt: {=bool:?}, hfrco1: {=bool:?}, hfxo0: {=bool:?}, i2c0: {=bool:?}, wdog0: {=bool:?}, wdog1: {=bool:?}, eusart0: {=bool:?}, semailbox: {=bool:?}, ahbradio: {=bool:?} }}",
                self.keyscan(),
                self.dmem(),
                self.radioaes(),
                self.smu(),
