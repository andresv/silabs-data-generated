...
pub mod regs {
    ...
    impl Bmpupatd0 {
        ...
        #[doc = "MVPAHBDATA0 privileged mode."]
        #[must_use]
        #[inline(always)]
        pub const fn mvpahbdata0(&self) -> bool {
            let val = (self.0 >> 3usize) & 0x01;
            val != 0
        }
        #[doc = "MVPAHBDATA0 privileged mode."]
        #[inline(always)]
        pub const fn set_mvpahbdata0(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
        }
        #[doc = "MVPAHBDATA1 privileged mode."]
        #[must_use]
        #[inline(always)]
        pub const fn mvpahbdata1(&self) -> bool {
            let val = (self.0 >> 4usize) & 0x01;
            val != 0
        }
        #[doc = "MVPAHBDATA1 privileged mode."]
        #[inline(always)]
        pub const fn set_mvpahbdata1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
        }
        #[doc = "MVPAHBDATA2 privileged mode."]
        #[must_use]
        #[inline(always)]
        pub const fn mvpahbdata2(&self) -> bool {
            let val = (self.0 >> 5usize) & 0x01;
            val != 0
        }
        #[doc = "MVPAHBDATA2 privileged mode."]
        #[inline(always)]
        pub const fn set_mvpahbdata2(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for Bmpupatd0 {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Bmpupatd0")
                ...
                .field("mvpahbdata0", &self.mvpahbdata0())
                .field("mvpahbdata1", &self.mvpahbdata1())
                .field("mvpahbdata2", &self.mvpahbdata2())
    ...
    impl defmt::Format for Bmpupatd0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Bmpupatd0 {{ radioaes: {=bool:?}, radiosubsystem: {=bool:?}, ldma: {=bool:?}, mvpahbdata0: {=bool:?}, mvpahbdata1: {=bool:?}, mvpahbdata2: {=bool:?}, rfeca0: {=bool:?}, rfeca1: {=bool:?}, seextdma: {=bool:?} }}",
                self.radioaes(),
                self.radiosubsystem(),
                self.ldma(),
                self.mvpahbdata0(),
    ...
    impl defmt::Format for Bmpusatd0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Bmpusatd0 {{ radioaes: {=bool:?}, radiosubsystem: {=bool:?}, ldma: {=bool:?}, mvpahbdata0: {=bool:?}, mvpahbdata1: {=bool:?}, mvpahbdata2: {=bool:?}, rfeca0: {=bool:?}, rfeca1: {=bool:?}, seextdma: {=bool:?} }}",
                self.radioaes(),
                self.radiosubsystem(),
                self.ldma(),
                self.mvpahbdata0(),
    ...
    impl defmt::Format for Ppupatd0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ppupatd0 {{ emu: {=bool:?}, cmu: {=bool:?}, hfrco0: {=bool:?}, fsrco: {=bool:?}, dpll0: {=bool:?}, lfxo: {=bool:?}, lfrco: {=bool:?}, ulfrco: {=bool:?}, msc: {=bool:?}, icache0: {=bool:?}, prs: {=bool:?}, gpio: {=bool:?}, ldma: {=bool:?}, ldmaxbar: {=bool:?}, timer0: {=bool:?}, timer1: {=bool:?}, timer2: {=bool:?}, timer3: {=bool:?}, timer4: {=bool:?}, usart0: {=bool:?}, burtc: {=bool:?}, i2c1: {=bool:?}, chiptestctrl: {=bool:?}, syscfgcfgns: {=bool:?}, syscfg: {=bool:?}, buram: {=bool:?}, gpcrc: {=bool:?}, dcdc: {=bool:?}, hostmailbox: {=bool:?}, eusart1: {=bool:?}, sysrtc: {=bool:?} }}",
                self.emu(),
                self.cmu(),
                self.hfrco0(),
                self.fsrco(),
    ...
    impl defmt::Format for Ppupatd1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ppupatd1 {{ keyscan: {=bool:?}, dmem: {=bool:?}, radioaes: {=bool:?}, smu: {=bool:?}, smucfgns: {=bool:?}, letimer0: {=bool:?}, iadc0: {=bool:?}, acmp0: {=bool:?}, acmp1: {=bool:?}, amuxcp0: {=bool:?}, vdac0: {=bool:?}, vdac1: {=bool:?}, pcnt: {=bool:?}, hfrco1: {=bool:?}, hfxo0: {=bool:?}, i2c0: {=bool:?}, wdog0: {=bool:?}, wdog1: {=bool:?}, eusart0: {=bool:?}, semailbox: {=bool:?}, mvp: {=bool:?}, ahbradio: {=bool:?} }}",
                self.keyscan(),
                self.dmem(),
                self.radioaes(),
                self.smu(),
    ...
    impl defmt::Format for Ppusatd0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ppusatd0 {{ emu: {=bool:?}, cmu: {=bool:?}, hfrco0: {=bool:?}, fsrco: {=bool:?}, dpll0: {=bool:?}, lfxo: {=bool:?}, lfrco: {=bool:?}, ulfrco: {=bool:?}, msc: {=bool:?}, icache0: {=bool:?}, prs: {=bool:?}, gpio: {=bool:?}, ldma: {=bool:?}, ldmaxbar: {=bool:?}, timer0: {=bool:?}, timer1: {=bool:?}, timer2: {=bool:?}, timer3: {=bool:?}, timer4: {=bool:?}, usart0: {=bool:?}, burtc: {=bool:?}, i2c1: {=bool:?}, chiptestctrl: {=bool:?}, syscfgcfgns: {=bool:?}, syscfg: {=bool:?}, buram: {=bool:?}, gpcrc: {=bool:?}, dcdc: {=bool:?}, hostmailbox: {=bool:?}, eusart1: {=bool:?}, sysrtc: {=bool:?} }}",
                self.emu(),
                self.cmu(),
                self.hfrco0(),
                self.fsrco(),
    ...
    impl defmt::Format for Ppusatd1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ppusatd1 {{ keyscan: {=bool:?}, dmem: {=bool:?}, radioaes: {=bool:?}, smu: {=bool:?}, smucfgns: {=bool:?}, letimer0: {=bool:?}, iadc0: {=bool:?}, acmp0: {=bool:?}, acmp1: {=bool:?}, amuxcp0: {=bool:?}, vdac0: {=bool:?}, vdac1: {=bool:?}, pcnt: {=bool:?}, hfrco1: {=bool:?}, hfxo0: {=bool:?}, i2c0: {=bool:?}, wdog0: {=bool:?}, wdog1: {=bool:?}, eusart0: {=bool:?}, semailbox: {=bool:?}, mvp: {=bool:?}, ahbradio: {=bool:?} }}",
                self.keyscan(),
                self.dmem(),
                self.radioaes(),
                self.smu(),
