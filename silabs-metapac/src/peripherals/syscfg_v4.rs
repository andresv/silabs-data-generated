...
pub mod regs {
    ...
    impl Cfgsystic {
        #[doc = "System-Tick External Clock Enable."]
        #[must_use]
        #[inline(always)]
    ...
    impl Dmem0portmapsel {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn ldmaportsel(&self) -> bool {
            let val = (self.0 >> 0usize) & 0x01;
            val != 0
        }
        #[doc = "LDMA portmap selection."]
        #[inline(always)]
        pub const fn set_ldmaportsel(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[doc = "SRWAES portmap selection."]
        #[must_use]
        #[inline(always)]
        pub const fn srwaesportsel(&self) -> bool {
            let val = (self.0 >> 1usize) & 0x01;
            val != 0
        }
        #[doc = "SRWAES portmap selection."]
        #[inline(always)]
        pub const fn set_srwaesportsel(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        #[doc = "AHBSRW portmap selection."]
        #[must_use]
        #[inline(always)]
        pub const fn ahbsrwportsel(&self) -> bool {
            let val = (self.0 >> 2usize) & 0x01;
            val != 0
        }
        #[doc = "AHBSRW portmap selection."]
        #[inline(always)]
        pub const fn set_ahbsrwportsel(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
        #[doc = "SRWECA0 portmap selection."]
        #[must_use]
        #[inline(always)]
        pub const fn srweca0portsel(&self) -> bool {
            let val = (self.0 >> 3usize) & 0x01;
            val != 0
        }
        #[doc = "SRWECA0 portmap selection."]
        #[inline(always)]
        pub const fn set_srweca0portsel(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
        }
        #[doc = "SRWECA1 portmap selection."]
        #[must_use]
        #[inline(always)]
        pub const fn srweca1portsel(&self) -> bool {
            let val = (self.0 >> 4usize) & 0x01;
            val != 0
        }
        #[doc = "SRWECA1 portmap selection."]
        #[inline(always)]
        pub const fn set_srweca1portsel(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
        }
        #[doc = "LDMA port1 portmap selection."]
        #[must_use]
        #[inline(always)]
        pub const fn ldma1portsel(&self) -> bool {
            let val = (self.0 >> 5usize) & 0x01;
            val != 0
        }
        #[doc = "LDMA port1 portmap selection."]
        #[inline(always)]
        pub const fn set_ldma1portsel(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize);
        }
        #[doc = "SRWLDMA port1 portmap selection."]
        #[must_use]
        #[inline(always)]
        pub const fn srwldmaportsel(&self) -> bool {
            let val = (self.0 >> 6usize) & 0x01;
            val != 0
        }
        #[doc = "SRWLDMA port1 portmap selection."]
        #[inline(always)]
        pub const fn set_srwldmaportsel(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize);
        }
        #[doc = "USB portmap selection."]
        #[must_use]
        #[inline(always)]
        pub const fn usbportsel(&self) -> bool {
            let val = (self.0 >> 7usize) & 0x01;
            val != 0
        }
        #[doc = "USB portmap selection."]
        #[inline(always)]
        pub const fn set_usbportsel(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize);
        }
        #[doc = "BUFC portmap selection."]
        #[must_use]
        #[inline(always)]
        pub const fn bufcportsel(&self) -> bool {
            let val = (self.0 >> 8usize) & 0x01;
            val != 0
        }
        #[doc = "BUFC portmap selection."]
        #[inline(always)]
        pub const fn set_bufcportsel(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for Dmem0portmapsel {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Dmem0portmapsel")
                ...
                .field("ldma1portsel", &self.ldma1portsel())
                .field("srwldmaportsel", &self.srwldmaportsel())
                .field("usbportsel", &self.usbportsel())
                .field("bufcportsel", &self.bufcportsel())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Dmem0portmapsel {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Dmem0portmapsel {{ ldmaportsel: {=bool:?}, srwaesportsel: {=bool:?}, ahbsrwportsel: {=bool:?}, srweca0portsel: {=bool:?}, srweca1portsel: {=bool:?}, ldma1portsel: {=bool:?}, srwldmaportsel: {=bool:?}, usbportsel: {=bool:?}, bufcportsel: {=bool:?} }}",
                self.ldmaportsel(),
                self.srwaesportsel(),
                self.ahbsrwportsel(),
                self.srweca0portsel(),
    ...
    impl Ien {
        ...
        #[doc = "HOST2SRWBUSERR Interrupt Enable."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "SRW2HOSTBUSERR Interrupt Enable."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "SRW2SOFTMBUSERR Interrupt Enable."]
        #[must_use]
        #[inline(always)]
        pub const fn srw2softmbuserr(&self) -> bool {
            let val = (self.0 >> 17usize) & 0x01;
            val != 0
        }
        #[doc = "SRW2SOFTMBUSERR Interrupt Enable."]
        #[inline(always)]
        pub const fn set_srw2softmbuserr(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize);
        }
        #[doc = "SOFTM2SRWBUSERR Interrupt Enable."]
        #[must_use]
        #[inline(always)]
        pub const fn softm2srwbuserr(&self) -> bool {
            let val = (self.0 >> 18usize) & 0x01;
            val != 0
        }
        #[doc = "SOFTM2SRWBUSERR Interrupt Enable."]
        #[inline(always)]
        pub const fn set_softm2srwbuserr(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 18usize)) | (((val as u32) & 0x01) << 18usize);
        }
        #[doc = "Softm bus error interrupt Enable."]
        #[must_use]
        #[inline(always)]
        pub const fn softmbuserrien(&self) -> bool {
            let val = (self.0 >> 20usize) & 0x01;
            val != 0
        }
        #[doc = "Softm bus error interrupt Enable."]
        #[inline(always)]
        pub const fn set_softmbuserrien(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 20usize)) | (((val as u32) & 0x01) << 20usize);
        }
        #[doc = "Softm DTCM Error Interrupt Enable."]
        #[must_use]
        #[inline(always)]
        pub const fn softmdtcmramerrien(&self) -> bool {
            let val = (self.0 >> 21usize) & 0x01;
            val != 0
        }
        #[doc = "Softm DTCM Error Interrupt Enable."]
        #[inline(always)]
        pub const fn set_softmdtcmramerrien(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 21usize)) | (((val as u32) & 0x01) << 21usize);
        }
        #[doc = "Softm ITCM Error Interrupt Enable."]
        #[must_use]
        #[inline(always)]
        pub const fn softmitcmramerrien(&self) -> bool {
            let val = (self.0 >> 22usize) & 0x01;
            val != 0
        }
        #[doc = "Softm ITCM Error Interrupt Enable."]
        #[inline(always)]
        pub const fn set_softmitcmramerrien(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for Ien {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ien")
                ...
                .field("srw2softmbuserr", &self.srw2softmbuserr())
                .field("softm2srwbuserr", &self.softm2srwbuserr())
                .field("softmbuserrien", &self.softmbuserrien())
                .field("softmdtcmramerrien", &self.softmdtcmramerrien())
                .field("softmitcmramerrien", &self.softmitcmramerrien())
    ...
    impl defmt::Format for Ien {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ien {{ sw0: {=bool:?}, sw1: {=bool:?}, sw2: {=bool:?}, sw3: {=bool:?}, fpioc: {=bool:?}, fpdzc: {=bool:?}, fpufc: {=bool:?}, fpofc: {=bool:?}, fpidc: {=bool:?}, fpixc: {=bool:?}, host2srwbuserr: {=bool:?}, srw2hostbuserr: {=bool:?}, srw2softmbuserr: {=bool:?}, softm2srwbuserr: {=bool:?}, softmbuserrien: {=bool:?}, softmdtcmramerrien: {=bool:?}, softmitcmramerrien: {=bool:?}, seqramerr1b: {=bool:?}, seqramerr2b: {=bool:?}, frcramerr1b: {=bool:?}, frcramerr2b: {=bool:?} }}",
                self.sw0(),
                self.sw1(),
                self.sw2(),
                self.sw3(),
                ...
                self.host2srwbuserr(),
                self.srw2hostbuserr(),
                self.srw2softmbuserr(),
                self.softm2srwbuserr(),
                self.softmbuserrien(),
                self.softmdtcmramerrien(),
                self.softmitcmramerrien(),
                self.seqramerr1b(),
                self.seqramerr2b(),
                self.frcramerr1b(),
                self.frcramerr2b()
    ...
    impl If {
        ...
        #[doc = "HOST2SRWBUSERR Interrupt Flag."]
        #[must_use]
        #[inline(always)]
        pub const fn host2srwbuserr(&self) -> bool {
            let val = (self.0 >> 15usize) & 0x01;
        ...
        #[doc = "SRW2HOSTBUSERR Interrupt Flag."]
        #[must_use]
        #[inline(always)]
        pub const fn srw2hostbuserr(&self) -> bool {
            let val = (self.0 >> 16usize) & 0x01;
        ...
        #[doc = "SRW2SOFTMBUSERR Interrupt Flag."]
        #[must_use]
        #[inline(always)]
        pub const fn srw2softmbuserr(&self) -> bool {
            let val = (self.0 >> 17usize) & 0x01;
        ...
        #[doc = "SOFTM2SRWBUSERR Interrupt Flag."]
        #[must_use]
        #[inline(always)]
        pub const fn softm2srwbuserr(&self) -> bool {
            let val = (self.0 >> 18usize) & 0x01;
        ...
        #[doc = "Softm bus error Interrupt Flag."]
        #[must_use]
        #[inline(always)]
        pub const fn softmbuserrif(&self) -> bool {
            let val = (self.0 >> 20usize) & 0x01;
            val != 0
        }
        #[doc = "Softm bus error Interrupt Flag."]
        #[inline(always)]
        pub const fn set_softmbuserrif(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 20usize)) | (((val as u32) & 0x01) << 20usize);
        }
        #[doc = "Softm DTCM Error Interrupt Flag."]
        #[must_use]
        #[inline(always)]
        pub const fn softmdtcmramerrif(&self) -> bool {
            let val = (self.0 >> 21usize) & 0x01;
            val != 0
        }
        #[doc = "Softm DTCM Error Interrupt Flag."]
        #[inline(always)]
        pub const fn set_softmdtcmramerrif(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 21usize)) | (((val as u32) & 0x01) << 21usize);
        }
        #[doc = "Softm ITCM Error Interrupt Flag."]
        #[must_use]
        #[inline(always)]
        pub const fn softmitcmramerrif(&self) -> bool {
            let val = (self.0 >> 22usize) & 0x01;
            val != 0
        }
        #[doc = "Softm ITCM Error Interrupt Flag."]
        #[inline(always)]
        pub const fn set_softmitcmramerrif(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize);
        }
    ...
    impl core::fmt::Debug for If {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("If")
                ...
                .field("srw2softmbuserr", &self.srw2softmbuserr())
                .field("softm2srwbuserr", &self.softm2srwbuserr())
                .field("softmbuserrif", &self.softmbuserrif())
                .field("softmdtcmramerrif", &self.softmdtcmramerrif())
                .field("softmitcmramerrif", &self.softmitcmramerrif())
                .field("seqramerr1b", &self.seqramerr1b())
                .field("seqramerr2b", &self.seqramerr2b())
                .field("frcramerr1b", &self.frcramerr1b())
                .field("frcramerr2b", &self.frcramerr2b())
    ...
    impl defmt::Format for If {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "If {{ sw0: {=bool:?}, sw1: {=bool:?}, sw2: {=bool:?}, sw3: {=bool:?}, fpioc: {=bool:?}, fpdzc: {=bool:?}, fpufc: {=bool:?}, fpofc: {=bool:?}, fpidc: {=bool:?}, fpixc: {=bool:?}, host2srwbuserr: {=bool:?}, srw2hostbuserr: {=bool:?}, srw2softmbuserr: {=bool:?}, softm2srwbuserr: {=bool:?}, softmbuserrif: {=bool:?}, softmdtcmramerrif: {=bool:?}, softmitcmramerrif: {=bool:?}, seqramerr1b: {=bool:?}, seqramerr2b: {=bool:?}, frcramerr1b: {=bool:?}, frcramerr2b: {=bool:?} }}",
                self.sw0(),
                self.sw1(),
                self.sw2(),
                self.sw3(),
                ...
                self.softm2srwbuserr(),
                self.softmbuserrif(),
                self.softmdtcmramerrif(),
                self.softmitcmramerrif(),
                self.seqramerr1b(),
                self.seqramerr2b(),
                self.frcramerr1b(),
                self.frcramerr2b()
    ...
    impl Radioramretnctrl {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn itcramretnctrl(&self) -> super::vals::Itcramretnctrl {
            let val = (self.0 >> 12usize) & 0x03ff;
            super::vals::Itcramretnctrl::from_bits(val as u16)
        }
        #[doc = "ITCRAM Retention Control."]
        #[inline(always)]
        pub const fn set_itcramretnctrl(&mut self, val: super::vals::Itcramretnctrl) {
            self.0 = (self.0 & !(0x03ff << 12usize)) | (((val.to_bits() as u32) & 0x03ff) << 12usize);
        }
        #[doc = "DTCRAM Retention Control."]
        #[must_use]
        #[inline(always)]
        pub const fn dtcramretnctrl(&self) -> super::vals::Dtcramretnctrl {
            let val = (self.0 >> 24usize) & 0x03;
            super::vals::Dtcramretnctrl::from_bits(val as u8)
        }
        #[doc = "DTCRAM Retention Control."]
        #[inline(always)]
        pub const fn set_dtcramretnctrl(&mut self, val: super::vals::Dtcramretnctrl) {
            self.0 = (self.0 & !(0x03 << 24usize)) | (((val.to_bits() as u32) & 0x03) << 24usize);
        }
        #[doc = "AHBRAM Retention Control."]
        #[must_use]
        #[inline(always)]
        pub const fn ahbramretnctrl(&self) -> super::vals::Ahbramretnctrl {
            let val = (self.0 >> 28usize) & 0x0f;
            super::vals::Ahbramretnctrl::from_bits(val as u8)
        }
        #[doc = "AHBRAM Retention Control."]
        #[inline(always)]
        pub const fn set_ahbramretnctrl(&mut self, val: super::vals::Ahbramretnctrl) {
    ...
    impl core::fmt::Debug for Radioramretnctrl {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Radioramretnctrl")
                ...
                .field("itcramretnctrl", &self.itcramretnctrl())
                .field("dtcramretnctrl", &self.dtcramretnctrl())
                .field("ahbramretnctrl", &self.ahbramretnctrl())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Radioramretnctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Radioramretnctrl {{ seqramretnctrl: {:?}, frcramretnctrl: {=bool:?}, itcramretnctrl: {:?}, dtcramretnctrl: {:?}, ahbramretnctrl: {:?} }}",
                self.seqramretnctrl(),
                self.frcramretnctrl(),
                self.itcramretnctrl(),
                self.dtcramretnctrl(),
    ...
    impl Rootlockstatus {
        ...
        #[doc = "Radio Soft Modem Debug Lock."]
        #[must_use]
        #[inline(always)]
        pub const fn radiosmdbglock(&self) -> bool {
            let val = (self.0 >> 22usize) & 0x01;
            val != 0
        }
        #[doc = "Radio Soft Modem Debug Lock."]
        #[inline(always)]
        pub const fn set_radiosmdbglock(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize);
        }
        #[doc = "E-Fuse Unlocked."]
        #[must_use]
    ...
    impl core::fmt::Debug for Rootlockstatus {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Rootlockstatus")
                ...
                .field("radiosmdbglock", &self.radiosmdbglock())
    ...
    impl defmt::Format for Rootlockstatus {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rootlockstatus {{ buslock: {=bool:?}, reglock: {=bool:?}, mfrlock: {=bool:?}, rootdbglock: {=bool:?}, userdbgaplock: {=bool:?}, userdbglock: {=bool:?}, usernidlock: {=bool:?}, userspidlock: {=bool:?}, userspnidlock: {=bool:?}, radiodbglock: {=bool:?}, radiosmdbglock: {=bool:?}, efuseunlocked: {=bool:?} }}",
                self.buslock(),
                self.reglock(),
                self.mfrlock(),
                self.rootdbglock(),
...
pub mod vals {
    ...
    impl Ahbramretnctrl {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Ahbramretnctrl {
    ...
    impl From<u8> for Ahbramretnctrl {
        #[inline(always)]
        fn from(val: u8) -> Ahbramretnctrl {
            Ahbramretnctrl::from_bits(val)
        }
    }
    impl From<Ahbramretnctrl> for u8 {
        #[inline(always)]
        fn from(val: Ahbramretnctrl) -> u8 {
            Ahbramretnctrl::to_bits(val)
        }
    }
    #[repr(transparent)]
    ...
    impl Dtcramretnctrl {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Dtcramretnctrl {
    ...
    impl From<u8> for Dtcramretnctrl {
        #[inline(always)]
        fn from(val: u8) -> Dtcramretnctrl {
            Dtcramretnctrl::from_bits(val)
        }
    }
    impl From<Dtcramretnctrl> for u8 {
        #[inline(always)]
        fn from(val: Dtcramretnctrl) -> u8 {
            Dtcramretnctrl::to_bits(val)
        }
    }
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Itcramretnctrl(u16);
    impl Itcramretnctrl {
        #[doc = "None of the RAM blocks powered down."]
        pub const Allon: Self = Self(0x0);
        #[doc = "Power down RAM block 9."]
        pub const Blk9: Self = Self(0x0200);
        #[doc = "Power down RAM block 8 and above."]
        pub const Blk8to9: Self = Self(0x0300);
        #[doc = "Power down RAM block 7 and above."]
        pub const Blk7to9: Self = Self(0x0380);
        #[doc = "Power down RAM block 6 and above."]
        pub const Blk6to9: Self = Self(0x03c0);
        #[doc = "Power down RAM block 5 and above."]
        pub const Blk5to9: Self = Self(0x03e0);
        #[doc = "Power down RAM block 4 and above."]
        pub const Blk4to9: Self = Self(0x03f0);
        #[doc = "Power down RAM block 3 and above."]
        pub const Blk3to9: Self = Self(0x03f8);
        #[doc = "Power down RAM block 2 and above."]
        pub const Blk2to9: Self = Self(0x03fc);
        #[doc = "Power down RAM block 1 and above."]
        pub const Blk1to9: Self = Self(0x03fe);
        #[doc = "All of the RAM blocks powered down."]
        pub const Alloff: Self = Self(0x03ff);
    }
    impl Itcramretnctrl {
        pub const fn from_bits(val: u16) -> Itcramretnctrl {
            Self(val & 0x03ff)
        }
        pub const fn to_bits(self) -> u16 {
            self.0
    ...
    impl core::fmt::Debug for Itcramretnctrl {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            match self.0 {
                0x0 => f.write_str("Allon"),
                0x0200 => f.write_str("Blk9"),
                0x0300 => f.write_str("Blk8to9"),
                0x0380 => f.write_str("Blk7to9"),
                0x03c0 => f.write_str("Blk6to9"),
                0x03e0 => f.write_str("Blk5to9"),
                0x03f0 => f.write_str("Blk4to9"),
                0x03f8 => f.write_str("Blk3to9"),
                0x03fc => f.write_str("Blk2to9"),
                0x03fe => f.write_str("Blk1to9"),
                0x03ff => f.write_str("Alloff"),
                other => core::write!(f, "0x{:02X}", other),
            }
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Itcramretnctrl {
        fn format(&self, f: defmt::Formatter) {
            match self.0 {
                0x0 => defmt::write!(f, "Allon"),
                0x0200 => defmt::write!(f, "Blk9"),
                0x0300 => defmt::write!(f, "Blk8to9"),
                0x0380 => defmt::write!(f, "Blk7to9"),
                0x03c0 => defmt::write!(f, "Blk6to9"),
                0x03e0 => defmt::write!(f, "Blk5to9"),
                0x03f0 => defmt::write!(f, "Blk4to9"),
                0x03f8 => defmt::write!(f, "Blk3to9"),
                0x03fc => defmt::write!(f, "Blk2to9"),
                0x03fe => defmt::write!(f, "Blk1to9"),
                0x03ff => defmt::write!(f, "Alloff"),
                other => defmt::write!(f, "0x{:02X}", other),
            }
        }
    }
    impl From<u16> for Itcramretnctrl {
        #[inline(always)]
        fn from(val: u16) -> Itcramretnctrl {
            Itcramretnctrl::from_bits(val)
        }
    }
    impl From<Itcramretnctrl> for u16 {
        #[inline(always)]
        fn from(val: Itcramretnctrl) -> u16 {
            Itcramretnctrl::to_bits(val)
        }
    }
    #[repr(u8)]
    #[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
