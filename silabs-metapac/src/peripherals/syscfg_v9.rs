...
pub mod regs {
    ...
    impl Chiprev {
        #[doc = "Chip Part Number value."]
        #[must_use]
        #[inline(always)]
        pub const fn partnumber(&self) -> u16 {
            let val = (self.0 >> 0usize) & 0x0fff;
            val as u16
        }
        #[doc = "Chip Part Number value."]
        #[inline(always)]
        pub const fn set_partnumber(&mut self, val: u16) {
    ...
    impl defmt::Format for Chiprev {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Chiprev {{ partnumber: {=u16:?}, minor: {=u8:?}, major: {=u8:?} }}",
                self.partnumber(),
                self.minor(),
                self.major()
            )
    ...
    impl Chiprevhw {
        #[doc = "Hardwired Chip Part Number value."]
        #[must_use]
        #[inline(always)]
        pub const fn partnumber(&self) -> u16 {
            let val = (self.0 >> 0usize) & 0x0fff;
    ...
    impl defmt::Format for Chiprevhw {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Chiprevhw {{ partnumber: {=u16:?}, minor: {=u8:?}, major: {=u8:?} }}",
                self.partnumber(),
                self.minor(),
                self.major()
            )
    ...
    impl Dmem0portmapsel {
        ...
        #[doc = "MVPAHBDATA0 portmap selection."]
        #[must_use]
        #[inline(always)]
        pub const fn mvpahbdata0portsel(&self) -> u8 {
            let val = (self.0 >> 10usize) & 0x03;
            val as u8
        }
        #[doc = "MVPAHBDATA0 portmap selection."]
        #[inline(always)]
        pub const fn set_mvpahbdata0portsel(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 10usize)) | (((val as u32) & 0x03) << 10usize);
        }
        #[doc = "MVPAHBDATA1 portmap selection."]
        #[must_use]
        #[inline(always)]
        pub const fn mvpahbdata1portsel(&self) -> u8 {
            let val = (self.0 >> 12usize) & 0x03;
            val as u8
        }
        #[doc = "MVPAHBDATA1 portmap selection."]
        #[inline(always)]
        pub const fn set_mvpahbdata1portsel(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 12usize)) | (((val as u32) & 0x03) << 12usize);
        }
        #[doc = "MVPAHBDATA2 portmap selection."]
        #[must_use]
        #[inline(always)]
        pub const fn mvpahbdata2portsel(&self) -> u8 {
            let val = (self.0 >> 14usize) & 0x03;
            val as u8
        }
        #[doc = "MVPAHBDATA2 portmap selection."]
        #[inline(always)]
        pub const fn set_mvpahbdata2portsel(&mut self, val: u8) {
    ...
    impl core::fmt::Debug for Dmem0portmapsel {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Dmem0portmapsel")
                ...
                .field("mvpahbdata0portsel", &self.mvpahbdata0portsel())
                .field("mvpahbdata1portsel", &self.mvpahbdata1portsel())
                .field("mvpahbdata2portsel", &self.mvpahbdata2portsel())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Dmem0portmapsel {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Dmem0portmapsel {{ ldmaportsel: {=u8:?}, srwaesportsel: {=u8:?}, ahbsrwportsel: {=u8:?}, srweca0portsel: {=u8:?}, srweca1portsel: {=u8:?}, mvpahbdata0portsel: {=u8:?}, mvpahbdata1portsel: {=u8:?}, mvpahbdata2portsel: {=u8:?} }}",
                self.ldmaportsel(),
                self.srwaesportsel(),
                self.ahbsrwportsel(),
                self.srweca0portsel(),
                self.srweca1portsel(),
                self.mvpahbdata0portsel(),
                self.mvpahbdata1portsel(),
                self.mvpahbdata2portsel()
            )
        }
    }
    #[doc = "Configure to provide general RAM retention configuration."]
    ...
    impl Dmem0retnctrl {
        ...
        pub const fn ramretnctrl(&self) -> super::vals::Dmem0retnctrlRamretnctrl {
            ...
            super::vals::Dmem0retnctrlRamretnctrl::from_bits(val as u32)
        }
        #[doc = "DMEM0 blockset retention control."]
        #[inline(always)]
    ...
    impl Ien {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn host2srwbuserrien(&self) -> bool {
            let val = (self.0 >> 16usize) & 0x01;
            val != 0
        }
        #[doc = "HOST2SRWBUSERRIEN Interrupt Enable."]
        #[inline(always)]
        pub const fn set_host2srwbuserrien(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
        }
        #[doc = "SRW2HOSTBUSERRIEN Interrupt Enable."]
        #[must_use]
        #[inline(always)]
        pub const fn srw2hostbuserrien(&self) -> bool {
            let val = (self.0 >> 17usize) & 0x01;
            val != 0
        }
        #[doc = "SRW2HOSTBUSERRIEN Interrupt Enable."]
        #[inline(always)]
        pub const fn set_srw2hostbuserrien(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for Ien {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Ien")
                ...
                .field("host2srwbuserrien", &self.host2srwbuserrien())
                .field("srw2hostbuserrien", &self.srw2hostbuserrien())
    ...
    impl defmt::Format for Ien {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ien {{ sw0: {=bool:?}, sw1: {=bool:?}, sw2: {=bool:?}, sw3: {=bool:?}, fpioc: {=bool:?}, fpdzc: {=bool:?}, fpufc: {=bool:?}, fpofc: {=bool:?}, fpidc: {=bool:?}, fpixc: {=bool:?}, host2srwbuserrien: {=bool:?}, srw2hostbuserrien: {=bool:?}, seqramerr1b: {=bool:?}, seqramerr2b: {=bool:?}, frcramerr1b: {=bool:?}, frcramerr2b: {=bool:?} }}",
                self.sw0(),
                self.sw1(),
                self.sw2(),
                self.sw3(),
                ...
                self.fpidc(),
                self.fpixc(),
                self.host2srwbuserrien(),
                self.srw2hostbuserrien(),
                self.seqramerr1b(),
                self.seqramerr2b(),
                self.frcramerr1b(),
                self.frcramerr2b()
    ...
    impl If {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn host2srwbuserrif(&self) -> bool {
            let val = (self.0 >> 16usize) & 0x01;
            val != 0
        }
        #[doc = "HOST2SRWBUSERRIF Interrupt Flag."]
        #[inline(always)]
        pub const fn set_host2srwbuserrif(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
        }
        #[doc = "SRW2HOSTBUSERRIF Interrupt Flag."]
        #[must_use]
        #[inline(always)]
        pub const fn srw2hostbuserrif(&self) -> bool {
            let val = (self.0 >> 17usize) & 0x01;
            val != 0
        }
        #[doc = "SRW2HOSTBUSERRIF Interrupt Flag."]
        #[inline(always)]
        pub const fn set_srw2hostbuserrif(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize);
        }
    ...
    impl core::fmt::Debug for If {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("If")
                ...
                .field("fpidc", &self.fpidc())
                .field("fpixc", &self.fpixc())
                .field("host2srwbuserrif", &self.host2srwbuserrif())
                .field("srw2hostbuserrif", &self.srw2hostbuserrif())
                .field("seqramerr1b", &self.seqramerr1b())
                .field("seqramerr2b", &self.seqramerr2b())
                .field("frcramerr1b", &self.frcramerr1b())
                .field("frcramerr2b", &self.frcramerr2b())
    ...
    impl defmt::Format for If {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "If {{ sw0: {=bool:?}, sw1: {=bool:?}, sw2: {=bool:?}, sw3: {=bool:?}, fpioc: {=bool:?}, fpdzc: {=bool:?}, fpufc: {=bool:?}, fpofc: {=bool:?}, fpidc: {=bool:?}, fpixc: {=bool:?}, host2srwbuserrif: {=bool:?}, srw2hostbuserrif: {=bool:?}, seqramerr1b: {=bool:?}, seqramerr2b: {=bool:?}, frcramerr1b: {=bool:?}, frcramerr2b: {=bool:?} }}",
                self.sw0(),
                self.sw1(),
                self.sw2(),
                self.sw3(),
                ...
                self.fpidc(),
                self.fpixc(),
                self.host2srwbuserrif(),
                self.srw2hostbuserrif(),
                self.seqramerr1b(),
                self.seqramerr2b(),
                self.frcramerr1b(),
                self.frcramerr2b()
...
pub mod vals {
    ...
    pub struct Dmem0retnctrlRamretnctrl(u32);
    impl Dmem0retnctrlRamretnctrl {
        #[doc = "None of the RAM blocks powered down."]
        pub const Allon: Self = Self(0x0);
        #[doc = "Power down RAM block 31 (address range 0x2007C000-0x20080000)."]
        pub const Blk31: Self = Self(0x8000_0000);
        #[doc = "Power down RAM blocks 30 and above (address range 0x20078000-0x20080000)."]
        pub const Blk30to31: Self = Self(0xc000_0000);
        #[doc = "Power down RAM blocks 29 and above (address range 0x20074000-0x20080000)."]
        pub const Blk29to31: Self = Self(0xe000_0000);
        #[doc = "Power down RAM blocks 28 and above (address range 0x20070000-0x20080000)."]
        pub const Blk28to31: Self = Self(0xf000_0000);
        #[doc = "Power down RAM blocks 27 and above (address range 0x2006C000-0x20080000)."]
        pub const Blk27to31: Self = Self(0xf800_0000);
        #[doc = "Power down RAM blocks 26 and above (address range 0x20068000-0x20080000)."]
        pub const Blk26to31: Self = Self(0xfc00_0000);
        #[doc = "Power down RAM blocks 25 and above (address range 0x20064000-0x20080000)."]
        pub const Blk25to31: Self = Self(0xfe00_0000);
        #[doc = "Power down RAM blocks 24 and above (address range 0x20060000-0x20080000)."]
        pub const Blk24to31: Self = Self(0xff00_0000);
        #[doc = "Power down RAM blocks 23 and above (address range 0x2005C000-0x20080000)."]
        pub const Blk23to31: Self = Self(0xff80_0000);
        #[doc = "Power down RAM blocks 22 and above (address range 0x20058000-0x20080000)."]
        pub const Blk22to31: Self = Self(0xffc0_0000);
        #[doc = "Power down RAM blocks 21 and above (address range 0x20054000-0x20080000)."]
        pub const Blk21to31: Self = Self(0xffe0_0000);
        #[doc = "Power down RAM blocks 20 and above (address range 0x20050000-0x20080000)."]
        pub const Blk20to31: Self = Self(0xfff0_0000);
        #[doc = "Power down RAM blocks 19 and above (address range 0x2004C000-0x20080000)."]
        pub const Blk19to31: Self = Self(0xfff8_0000);
        #[doc = "Power down RAM blocks 18 and above (address range 0x20048000-0x20080000)."]
        pub const Blk18to31: Self = Self(0xfffc_0000);
        #[doc = "Power down RAM blocks 17 and above (address range 0x20044000-0x20080000)."]
        pub const Blk17to31: Self = Self(0xfffe_0000);
        #[doc = "Power down RAM blocks 16 and above (address range 0x20040000-0x20080000)."]
        pub const Blk16to31: Self = Self(0xffff_0000);
        #[doc = "Power down RAM blocks 15 and above (address range 0x2003C000-0x20080000)."]
        pub const Blk15to31: Self = Self(0xffff_8000);
        #[doc = "Power down RAM blocks 14 and above (address range 0x20038000-0x20080000)."]
        pub const Blk14to31: Self = Self(0xffff_c000);
        #[doc = "Power down RAM blocks 13 and above (address range 0x20034000-0x20080000)."]
        pub const Blk13to31: Self = Self(0xffff_e000);
        #[doc = "Power down RAM blocks 12 and above (address range 0x20030000-0x20080000)."]
        pub const Blk12to31: Self = Self(0xffff_f000);
        #[doc = "Power down RAM blocks 11 and above (address range 0x2002C000-0x20080000)."]
        pub const Blk11to31: Self = Self(0xffff_f800);
        #[doc = "Power down RAM blocks 10 and above (address range 0x20028000-0x20080000)."]
        pub const Blk10to31: Self = Self(0xffff_fc00);
        #[doc = "Power down RAM blocks 9 and above (address range 0x20024000-0x20080000)."]
        pub const Blk9to31: Self = Self(0xffff_fe00);
        #[doc = "Power down RAM blocks 8 and above (address range 0x20020000-0x20080000)."]
        pub const Blk8to31: Self = Self(0xffff_ff00);
        #[doc = "Power down RAM blocks 7 and above (address range 0x2001c000-0x20080000)."]
        pub const Blk7to31: Self = Self(0xffff_ff80);
        #[doc = "Power down RAM blocks 6 and above (address range 0x20018000-0x20080000)."]
        pub const Blk6to31: Self = Self(0xffff_ffc0);
        #[doc = "Power down RAM blocks 5 and above (address range 0x20014000-0x20080000)."]
        pub const Blk5to31: Self = Self(0xffff_ffe0);
        #[doc = "Power down RAM blocks 4 and above (address range 0x20010000-0x20080000)."]
        pub const Blk4to31: Self = Self(0xffff_fff0);
        #[doc = "Power down RAM blocks 3 and above (address range 0x2000c000-0x20080000)."]
        pub const Blk3to31: Self = Self(0xffff_fff8);
        #[doc = "Power down RAM blocks 2 and above (address range 0x20008000-0x20080000)."]
        pub const Blk2to31: Self = Self(0xffff_fffc);
        #[doc = "Power down RAM blocks 1 and above (address range 0x20004000-0x20080000)."]
        pub const Blk1to31: Self = Self(0xffff_fffe);
        #[doc = "All of the RAM blocks are powered down."]
        pub const Alloff: Self = Self(0xffff_ffff);
    }
    impl Dmem0retnctrlRamretnctrl {
        pub const fn from_bits(val: u32) -> Dmem0retnctrlRamretnctrl {
    ...
    impl core::fmt::Debug for Dmem0retnctrlRamretnctrl {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            match self.0 {
                ...
                0x8000_0000 => f.write_str("Blk31"),
                0xc000_0000 => f.write_str("Blk30to31"),
                0xe000_0000 => f.write_str("Blk29to31"),
                0xf000_0000 => f.write_str("Blk28to31"),
                0xf800_0000 => f.write_str("Blk27to31"),
                0xfc00_0000 => f.write_str("Blk26to31"),
                0xfe00_0000 => f.write_str("Blk25to31"),
                0xff00_0000 => f.write_str("Blk24to31"),
                0xff80_0000 => f.write_str("Blk23to31"),
                0xffc0_0000 => f.write_str("Blk22to31"),
                0xffe0_0000 => f.write_str("Blk21to31"),
                0xfff0_0000 => f.write_str("Blk20to31"),
                0xfff8_0000 => f.write_str("Blk19to31"),
                0xfffc_0000 => f.write_str("Blk18to31"),
                0xfffe_0000 => f.write_str("Blk17to31"),
                0xffff_0000 => f.write_str("Blk16to31"),
                0xffff_8000 => f.write_str("Blk15to31"),
                0xffff_c000 => f.write_str("Blk14to31"),
                0xffff_e000 => f.write_str("Blk13to31"),
                0xffff_f000 => f.write_str("Blk12to31"),
                0xffff_f800 => f.write_str("Blk11to31"),
                0xffff_fc00 => f.write_str("Blk10to31"),
                0xffff_fe00 => f.write_str("Blk9to31"),
                0xffff_ff00 => f.write_str("Blk8to31"),
                0xffff_ff80 => f.write_str("Blk7to31"),
                0xffff_ffc0 => f.write_str("Blk6to31"),
                0xffff_ffe0 => f.write_str("Blk5to31"),
                0xffff_fff0 => f.write_str("Blk4to31"),
                0xffff_fff8 => f.write_str("Blk3to31"),
                0xffff_fffc => f.write_str("Blk2to31"),
                0xffff_fffe => f.write_str("Blk1to31"),
                0xffff_ffff => f.write_str("Alloff"),
    ...
    impl defmt::Format for Dmem0retnctrlRamretnctrl {
        fn format(&self, f: defmt::Formatter) {
            match self.0 {
                ...
                0x8000_0000 => defmt::write!(f, "Blk31"),
                0xc000_0000 => defmt::write!(f, "Blk30to31"),
                0xe000_0000 => defmt::write!(f, "Blk29to31"),
                0xf000_0000 => defmt::write!(f, "Blk28to31"),
                0xf800_0000 => defmt::write!(f, "Blk27to31"),
                0xfc00_0000 => defmt::write!(f, "Blk26to31"),
                0xfe00_0000 => defmt::write!(f, "Blk25to31"),
                0xff00_0000 => defmt::write!(f, "Blk24to31"),
                0xff80_0000 => defmt::write!(f, "Blk23to31"),
                0xffc0_0000 => defmt::write!(f, "Blk22to31"),
                0xffe0_0000 => defmt::write!(f, "Blk21to31"),
                0xfff0_0000 => defmt::write!(f, "Blk20to31"),
                0xfff8_0000 => defmt::write!(f, "Blk19to31"),
                0xfffc_0000 => defmt::write!(f, "Blk18to31"),
                0xfffe_0000 => defmt::write!(f, "Blk17to31"),
                0xffff_0000 => defmt::write!(f, "Blk16to31"),
                0xffff_8000 => defmt::write!(f, "Blk15to31"),
                0xffff_c000 => defmt::write!(f, "Blk14to31"),
                0xffff_e000 => defmt::write!(f, "Blk13to31"),
                0xffff_f000 => defmt::write!(f, "Blk12to31"),
                0xffff_f800 => defmt::write!(f, "Blk11to31"),
                0xffff_fc00 => defmt::write!(f, "Blk10to31"),
                0xffff_fe00 => defmt::write!(f, "Blk9to31"),
                0xffff_ff00 => defmt::write!(f, "Blk8to31"),
                0xffff_ff80 => defmt::write!(f, "Blk7to31"),
                0xffff_ffc0 => defmt::write!(f, "Blk6to31"),
                0xffff_ffe0 => defmt::write!(f, "Blk5to31"),
                0xffff_fff0 => defmt::write!(f, "Blk4to31"),
                0xffff_fff8 => defmt::write!(f, "Blk3to31"),
                0xffff_fffc => defmt::write!(f, "Blk2to31"),
                0xffff_fffe => defmt::write!(f, "Blk1to31"),
                0xffff_ffff => defmt::write!(f, "Alloff"),
                other => defmt::write!(f, "0x{:02X}", other),
            }
        }
    }
    impl From<u32> for Dmem0retnctrlRamretnctrl {
        #[inline(always)]
        fn from(val: u32) -> Dmem0retnctrlRamretnctrl {
            Dmem0retnctrlRamretnctrl::from_bits(val)
        }
    }
    impl From<Dmem0retnctrlRamretnctrl> for u32 {
        #[inline(always)]
        fn from(val: Dmem0retnctrlRamretnctrl) -> u32 {
